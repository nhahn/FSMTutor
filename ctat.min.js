  ...
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      for (var e = {}, g = b.olson.dst_rules.zones, l = g.length, k = a[f], x = 0;x < l;x++) {
        var B = g[x], D;
        D = g[x];
        for (var p = 0, y = 0;y < d.length;y++) {
          if (D.rules[y] && d[y]) {
            if (d[y].s >= D.rules[y].s && d[y].e <= D.rules[y].e) {
              p = 0, p += Math.abs(d[y].s - D.rules[y].s), p += Math.abs(D.rules[y].e - d[y].e);
            } else {
              p = "N/A";
              break;
            }
      ...
      for (var v in e) {
        if (e.hasOwnProperty(v) && -1 != k.indexOf(v)) {
          return v;
        }
      }
      return f;
      ...
      var d = function() {
        for (var a = [], d = 0;d < b.olson.dst_rules.years.length;d++) {
          ...
          for (var g = (new Date(c)).getTimezoneOffset(), h = null, l = null;c < e - 864E5;) {
            var k = new Date(c), n = k.getTimezoneOffset();
            n !== g && (n < g && (h = k), n > g && (l = k), g = n);
            c += 864E5;
          }
          e = h && l ? {s:f(h).getTime(), e:f(l).getTime()} : !1;
          a.push(e);
        }
        return a;
      }();
...
(function(a, b) {
  ...
  function c(a, b, d, f) {
    ...
    m[e] || (q.insertRule("@" + (c && "-" + c + "-" || "") + "keyframes " + e + "{0%{opacity:" + f + "}" + d + "%{opacity:" + a + "}" + (d + .01) + "%{opacity:1}" + (d + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + f + "}}", q.cssRules.length), m[e] = 1);
    return e;
  }
  function e(a, b) {
    var d = a.style, f, e;
  ...
  function k() {
    ...
    h.prototype.lines = function(a, e) {
      function c() {
        return g(d("group", {coordsize:k + " " + k, coordorigin:-l + " " + -l}), {width:k, height:k});
      }
      function h(a, k, m) {
        b(u, b(g(c(), {rotation:360 / e.lines * a + "deg", left:~~k}), b(g(d("roundrect", {arcsize:e.corners}), {width:l, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:m}), d("fill", {color:f(e.color, a), opacity:e.opacity}), d("stroke", {opacity:0}))));
      }
      var l = e.scale * (e.length + e.width), k = 2 * e.scale * l, m = -(e.width + e.length) * e.scale * 2 + "px", u = g(c(), {position:"absolute", top:m, left:m});
      if (e.shadow) {
        for (m = 1;m <= e.lines;m++) {
          h(m, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
        }
      }
      for (m = 1;m <= e.lines;m++) {
        h(m);
  ...
  var l = ["webkit", "Moz", "ms", "O"], m = {}, n, q, r = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!n) {
      var c = 0, h = (f.lines - 1) * (1 - f.direction) / 2, l, k = f.fps, m = k / f.speed, u = (1 - f.opacity) / (m * f.trail / 100), q = m / f.lines;
      (function F() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          l = Math.max(1 - (c + (f.lines - a) * q) % m * u, f.opacity), d.opacity(e, a * f.direction + h, l, f);
        }
        d.timeout = d.el && setTimeout(F, ~~(1E3 / k));
      })();
    }
    return d;
  }, stop:function() {
    ...
    function h(b, d) {
      return g(a(), {position:"absolute", width:e.scale * (e.length + e.width) + "px", height:e.scale * e.width + "px", background:b, boxShadow:d, transformOrigin:"left", transform:"rotate(" + ~~(360 / e.lines * l + e.rotate) + "deg) translate(" + e.scale * e.radius + "px,0)", borderRadius:(e.corners * e.scale * e.width >> 1) + "px"});
    }
    for (var l = 0, k = (e.lines - 1) * (1 - e.direction) / 2, m;l < e.lines;l++) {
      m = g(a(), {position:"absolute", top:1 + ~(e.scale * e.width / 2) + "px", transform:e.hwaccel ? "translate3d(0,0,0)" : "", opacity:e.opacity, animation:n && c(e.opacity, e.trail, k + l * e.direction, e.lines) + " " + 1 / e.speed + "s linear infinite"}), e.shadow && b(m, g(h("#000", "0 0 4px #000"), {top:"2px"})), b(d, b(m, h(f(e.color, l), "0 0 1px rgba(0,0,0,.1)")));
    }
    return d;
  ...
  if ("undefined" !== typeof document) {
    ...
    var u = g(a("group"), {behavior:"url(#default#VML)"});
    !e(u, "transform") && u.adj ? k() : n = e(u, "animation");
  }
  return h;
});
...
var CTATGlobals = {tutorRunning:!1, Visual:{}, Font:{}, Tab:{Tracker:1, Focus:null, previousFocus:null}, NameSpace:{svg:"http://www.w3.org/2000/svg", xml:"http://www.w3.org/2000/xmlns/", xlink:"http://www.w3.org/1999/xlink", ev:"http://www.w3.org/2001/xml-events", mathml:"http://www.w3.org/1998/Math/MathML"}}, useDebugging;
...
var commLibrary = CTATGlobals.selectedTextInput = null, commLMSService = null, commMessageBuilder = null, commMessageHandler = null, commLogMessageBuilder = null, commLoggingLibrary = null, logHintSAI = null, nameTranslator = null, hints = [], hintIndex = 0, caseInsensitive = !0, unordered = !0, lockWidget = !0;
CTATGlobals.suppressStudentFeedback = !1;
var highlightRightSelection = !0, confirmDone = !1, globalGlowStringContent = "0px 0px 15px 5px rgba(255, 255, 0, 1.0)", globalGlowString = "-webkit-box-shadow: " + globalGlowStringContent + "; -moz-box-shadow: " + globalGlowStringContent + "; box-shadow: " + globalGlowStringContent + "; ", globalCorrectString = "-webkit-box-shadow: 0px 0px 15px 5px rgba(0, 255, 0, 1.0); -moz-box-shadow: 0px 0px 15px 5px rgba(0, 255, 0, 1.0); box-shadow: 0px 0px 15px 5px rgba(0, 255, 0, 1.0); ", globalInCorrectString = 
...
function setVariable(a, b) {
  ...
  var c = window.btoa(b);
  console.log("Constructed xblock handler url: " + xblockRuntime.handlerUrl(xblockElement, "ctat_set_variable"));
  $.ajax({type:"POST", url:xblockRuntime.handlerUrl(xblockElement, "ctat_set_variable"), data:'{"' + a + '": "' + c + '"}', success:function(a) {
    console.log("success");
...
function gradeStudent(a) {
  console.log("gradeStudent (" + a + ")");
  xblockRuntime.publish(self, "grade", {value:a, max_value:100});
}
function CTATXBlock(a, b) {
  ...
  $(function(a) {
    console.log("$ ()");
    a = a(b).data("runtime-version");
    if (void 0 === a) {
      return console.log("Error, we're not running in an XBlock environment!"), null;
    }
    console.log("XBlock runtime environment version: " + a);
    loadCTAT();
    setVariable("saveandrestore", "<messages><message><verb>NotePropertySet</verb><properties><MessageType>InterfaceAction</MessageType><transaction_id>a31cefb8-7def-b8a5-978b-52864345dc5a</transaction_id><Selection><value>cdf1</value></Selection><Action><value>UpdateTextField</value></Action><Input><value><![CDATA[5]]\x3e</value></Input></properties></message><message><verb>NotePropertySet</verb><properties><MessageType>InterfaceAction</MessageType><transaction_id>572a12ec-c163-2fbe-acd8-61f2718959d0</transaction_id><Selection><value>cdf2</value></Selection><Action><value>UpdateTextField</value></Action><Input><value><![CDATA[15]]\x3e</value></Input></properties></message><message><verb>NotePropertySet</verb><properties><MessageType>InterfaceAction</MessageType><transaction_id>0b9e68ca-45fe-a3f8-57d1-0eea7cb517e0</transaction_id><Selection><value>cdf3</value></Selection><Action><value>UpdateTextField</value></Action><Input><value><![CDATA[64]]\x3e</value></Input></properties></message><message><verb>NotePropertySet</verb><properties><MessageType>UntutoredAction</MessageType><transaction_id>011aa819-110b-82f9-61ae-b0ccda8700a5</transaction_id><Selection><value>q1consider</value></Selection><Action><value>UpdateTextArea</value></Action><Input><value><![CDATA[restore me, baby]]\x3e</value></Input></properties></message><message><verb>NotePropertySet</verb><properties><MessageType>InterfaceAction</MessageType><transaction_id>14b4543e-2c56-a821-5060-f781b58a0163</transaction_id><Selection><value>q1consider</value></Selection><Action><value>UpdateTextArea</value></Action><Input><value><![CDATA[restore me, baby]]\x3e</value></Input></properties></message><message><verb>NotePropertySet</verb><properties><MessageType>UntutoredAction</MessageType><transaction_id>82449483-c620-0a9b-271c-78f3752c822e</transaction_id><Selection><value>q1plan_id</value></Selection><Action><value>UpdateCheckBox</value></Action><Input><value><![CDATA[Gender: false;Alcohol: true;Height: false;Cheat: false]]\x3e</value></Input></properties></message><message><verb>NotePropertySet</verb><properties><MessageType>InterfaceAction</MessageType><transaction_id>51ee8a61-1238-4a22-2b9f-4cb70ca2ceb7</transaction_id><Selection><value>q1plan_id</value></Selection><Action><value>UpdateCheckBox</value></Action><Input><value><![CDATA[Gender: false;Alcohol: true;Height: false;Cheat: false]]\x3e</value></Input></properties></message></messages>");
    console.log("$ () done");
  });
...
;var CTATGlobalFunctions = {stringToBoolean:function(a) {
  ...
  return window && window.frameElement && window.frameElement.getAttribute("data-params") ? jQuery.parseJSON(window.frameElement.getAttribute("data-params")) : {admit_code:"ies", authenticity_token:"none", auth_token:"none", BehaviorRecorderMode:"AuthorTimeTutoring", class_name:"", curriculum_service_url:"", dataset_level_name:"", dataset_level_name1:"Unit1", dataset_level_type1:"unit", dataset_level_type:"ProblemSet", dataset_name:"FlashLoggingTest_xxx", expire_logout_url:"none", info:"", instructor_name:"none", 
  instrumentation_log:"off", lcId:"none", Logging:"None", log_service_url:"http://pslc-qa.andrew.cmu.edu/log/server", log_to_disk_directory:".", keyboard:"disabled", problem_name:"xxx", problem_position:"none", problem_started_url:"none", problem_state_status:"empty", question_file:"", refresh_session_url:"none", remoteSocketPort:"80", remoteSocketURL:"http://localhost", restore_problem_url:"none", reuse_swf:"false", run_problem_url:"none", school_name:"none", SessionLog:"true", session_id:"none", 
...
function parseQueryString() {
  ...
  if (b) {
    for (var b = b.split("&"), c = 0;c < b.length;c++) {
      var e = b[c].split("=");
      a[unescape(e[0].replace(/\+/g, " "))] = unescape(e[1].replace(/\+/g, " "));
    }
  }
  return a;
}
...
function tutorPrep(a) {
  ...
  var b = [];
  if (CTATConfig.platform_is_CTAT()) {
  ...
  for (e in b) {
    switch(ctatdebug("Processing external FlashVar " + e + "(" + b[e] + ")"), e) {
      ...
      case "SessionLog":
        a.SessionLog = b[e];
      case "KEYBOARDGROUP":
        "Disabled" == b[e] && (a.keyboard = "disabled"), "Auto" == b[e] && (a.keyboard = "auto"), "On" == b[e] && (a.keyboard = "on");
    }
  }
  return a;
}
...
;var CTATBase = function(a, b) {
  ...
  CTATBase.inCTAT = function() {
    return "undefined" != typeof CTATTarget && "CTAT" == CTATTarget;
  };
...
function ctatdebug(a) {
  useDebugging && null !== a && ("google" == CTATConfig.platform ? Logger.log(formatLogMessageGoogle("CTATTutor", "tutor", a)) : (null === debugPointer && (debugPointer = new CTATBase("CTATTutor", "tutor")), debugPointer.ctatdebug(a, "CTATTutor")));
}
...
var CTATGraphicsTools = function(a, b, c, e, g, d) {
  ...
  var q = 0, r = this;
  if (null == n) {
    return r.ctatdebug("--- Error: Must pass a canvas context. ---"), -1;
  }
  0 == a && (q = .5);
  ...
  this.drawLine = function(a, b, d, f, e, c) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawLine");
    a += q;
    d += q;
    b += q;
    f += q;
  ...
  this.drawCircle = function(a, b, d) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawCircle");
    a += q;
    b += q;
    n.strokeStyle = h;
    n.lineWidth = f;
  ...
  this.drawCircleFilled = function(a, b, d) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawCircleFilled");
    a += q;
    b += q;
    n.fillStyle = k;
    n.beginPath();
  ...
  this.drawRectangle = function(a, b, d, e) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangle");
    a += q;
    b += q;
    n.lineWidth = f;
    1 == l ? (n.fillStyle = k, n.fillRect(a, b, d, e)) : (n.strokeStyle = h, n.beginPath(), n.rect(a, b, d, e), n.stroke());
  };
  this.drawRectangleFilled = function(a, b, d, f) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangleFilled");
    a += q;
    b += q;
    n.fillStyle = k;
    n.fillRect(a, b, d, f);
  ...
  this.drawTriangle = function(a, b, d, e, c, g) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangle");
    a += q;
    d += q;
    c += q;
    b += q;
  ...
  this.drawTriangleFilled = function(a, b, d, e, c, g) {
    null == n && r.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangleFilled");
    a += q;
    d += q;
    c += q;
    b += q;
...
;var CTATShape = function(a, b, c, e, g, d) {
  ...
  var h = [], k = [], l = g, m = d, n = b, q = void 0, r = "black", u = "black", t = "Arial", w = 12, x = [], B = 1, D = 5, p = document.createElement("canvas");
  p.id = n;
  p.width = l;
  p.height = m;
  var y = new CTATCSS;
  y.addCSSAttribute("position", "absolute");
  y.addCSSAttribute("left", c + "px");
  y.addCSSAttribute("top", e + "px");
  y.addCSSAttribute("visibility", "visible");
  y.addCSSAttribute("background-color", "rgba(0, 0, 0, 0)");
  y.addCSSAttribute("border-style", "none");
  p.setAttribute("style", y.toCSSString());
  getSafeElementById(a).appendChild(p);
  var v = new CTATGraphicsTools(p.getContext("2d"));
  v.setGraphicBorderWidth(B);
  v.setLineColor(r);
  v.setFillColor(u);
  ...
  this.setXPoints = function(a) {
    h = a;
    y.modifyCSSAttribute("left", h[0] + "px");
    p.setAttribute("style", y.toCSSString());
  };
  this.setYPoints = function(a) {
    k = a;
    y.modifyCSSAttribute("top", k[0] + "px");
    p.setAttribute("style", y.toCSSString());
  };
  this.setWidth = function(b) {
    l = b;
    "main-canvas" != a && (p.width = l);
  };
  this.setHeight = function(b) {
    m = b;
    "main-canvas" != a && (p.height = m);
  };
  this.setName = function(a) {
    n = a;
  };
  ...
  this.modifyCanvasCSS = function(a, b) {
    y.modifyCSSAttribute(a, b);
    p.setAttribute("style", y.toCSSString());
  };
  this.detatchCanvas = function() {
    a == ctatcontainer ? getSafeElementById(a).removeChild(p) : getSafeElementById("ctatdiv" + a).removeChild(p);
  };
  this.shapeMagicTrigFunctionX = function(a) {
    v.magicTrigFunctionX(a);
  };
  this.shapeMagicTrigFunctionY = function(a) {
    v.magicTrigFunctionY(a);
  };
  this.drawLine = function() {
    v.drawLine(h[0] + B, k[0] + B, h[1], k[1], r, B);
  };
  this.drawCircle = function() {
    v.drawCircle(h[0] + D, k[0] + D, D);
  };
  this.drawCircleFilled = function() {
    v.drawCircleFilled(h[0] + D, k[0] + D, D - 1);
  };
  this.drawRectangle = function(a, b, d, e) {
    v.drawRectangle(a[0] + B, b[0] + B, l - B, m - B);
  };
  this.drawRectangleFilled = function() {
    v.drawRectangleFilled(h[0], k[0], l, m);
  };
  this.drawRoundedRect = function() {
    v.drawRoundedRect(h[0] + B, k[0] + B, l - D - B, m - D - B, D);
  };
  this.drawRoundedRectFilled = function() {
    v.drawRoundedRectFilled(h[0] + B, k[0] + B, l - D - B, m - D - B, D);
  };
  this.drawText = function() {
    v.drawText(w / 2, w / 2, q);
  };
  this.drawTriangle = function() {
    v.drawTriangle(h[0] + B, k[0] + B, h[1], k[1], h[2], k[2]);
  };
  this.drawTriangleFilled = function() {
    v.drawTriangleFilled(h[0], k[0], h[1], k[1], h[2], k[2]);
  };
  this.save = function() {
    v.save();
  };
  ...
  this.erase = function() {
    ...
    y.addCSSAttribute("border-style", "none");
    p.setAttribute("style", y.toCSSString());
    a == ctatcontainer ? getSafeElementById(a).appendChild(p) : getSafeElementById("ctatdiv" + a).appendChild(p);
    for (var b = 0;b < x.length;b++) {
      p.addEventListener(x[b][0], x[b][1]);
    }
  };
};
var CTATConnection = function(a) {
  CTATBase.call(this, "CTATConnection", a);
  var b = -1, c = "", e = null, g = null, d = !1, f = this;
  ...
  this.createHTTPObject = function() {
    f.ctatdebug("createHTTPObject ()");
    g = new XMLHttpRequest;
    if (window.XMLHttpRequest) {
      f.ctatdebug("Creating regular XMLHttpRequest ..."), g = new XMLHttpRequest, g.overrideMimeType && g.overrideMimeType("text/html");
    } else {
      if (f.ctatdebug("Trying alternative HTTP object creation ..."), window.ActiveXObject) {
        f.ctatdebug("Detected window.ActiveXObject ...");
        try {
          f.ctatdebug("Creating Msxml2.XMLHTTP ..."), g = new ActiveXObject("Msxml2.XMLHTTP");
        } catch (a) {
          try {
            f.ctatdebug("Creating Microsoft.XMLHTTP ..."), g = new ActiveXObject("Microsoft.XMLHTTP");
          } catch (b) {
  ...
  this.init = function() {
    ...
    if (null !== g) {
      ...
      "dummySession" == b && f.ctatdebug("Unable to find CTAT session information from environment, trying OLI ...");
      try {
        0 == useOLIEncoding && g.setRequestHeader("Content-type", "text/plain"), g.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), g.setRequestHeader("ctatsession", b);
      } catch (d) {
        alert("HTTP object creation error: " + d.message);
      }
    } else {
  ...
  this.send = function() {
    f.ctatdebug("send ()");
    f.getHTTPObject().onerror = function() {
      f.ctatdebug("Networking error!");
    };
    try {
      f.getHTTPObject().open("POST", c, !0);
    } catch (a) {
      f.ctatdebug("Error in newConnection.httpObject.open: " + a.message);
      return;
    }
    f.init();
    try {
      e ? f.getHTTPObject().send(e) : f.getHTTPObject().send();
    } catch (a) {
...
var CTATWSConnection = function(a) {
  CTATBase.call(this, "CTATWSConnection", a);
  var b = -1, c = "", e = "", g = !1, d = this, f = null, d = this, h = [], k = !1, l = 0, m = 0, n = null;
  this.setConsumed = function(a) {
    g = a;
    d.ctatdebug("consumed: " + g);
  };
  this.getConsumed = function() {
    d.ctatdebug("consumed: " + g);
    return g;
  ...
  this.init = function() {
    ...
    f.addEventListener("open", function(a) {
      d.ctatdebug("STATUS: open");
      k = !0;
      d.ctatdebug("Connection open, flushing outgoing queue ...");
      l = (new Date).getTime();
      if (0 < h.length) {
    ...
    f.addEventListener("message", function(a) {
      m = (new Date).getTime();
      d.ctatdebug("STATUS: message");
      d.ctatdebug("Received: " + a.data + " <b>(" + (m - l) + "ms)</b>");
      n ? n() : d.ctatdebug("Error: no processing function provided");
    });
    f.addEventListener("close", function(a) {
      d.ctatdebug("STATUS: close");
      k = !1;
    });
    f.addEventListener("error", function(a) {
      d.ctatdebug("STATUS: error");
      k = !1;
    });
  ...
  this.send = function() {
    d.ctatdebug("send ()");
    d.init();
    0 == k ? (d.ctatdebug("Connection not ready yet, storing ..."), h.push(e)) : (d.ctatdebug("Connection ready, sending data ..."), l = (new Date).getTime(), f.send(e));
  };
};
CTATWSConnection.prototype = Object.create(CTATBase.prototype);
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var f = c || 0, h = e || 0, k = g || -2, l = d || -2, m = 50, n = 25, q = !1, r = "", u = !1, t = !0, w = null, x = "", B = -1;
  this.isTabIndexable = !0;
  var D = 0, p = null, y = null, v = this, C = null, A = "hidden", z = CTATGlobalFunctions.gensym.z_index(), E = CTATGlobalFunctions.gensym.div_id(), F = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.setTabIndex = function(a) {
    !0 === this.isTabIndexable ? (B = a, 0 > B ? (B = CTATGlobals.Tab.Tracker, CTATGlobals.Tab.Tracker++) : CTATGlobals.Tab.Tracker = B) : B = -1;
  };
  this.getTabIndex = function() {
    return B;
  };
  this.setZIndex = function(a) {
    v.ctatdebug("Setting z index to: " + a);
    D = a;
  ...
  this.processCommShellEvent = function(a, b) {
    v.ctatdebug("processCommShellEvent (" + a + ")");
  };
  this.makeDivWrapper = function(a) {
    ...
    w.style.top = h + "px";
    w.style.zIndex = z;
    w.style.width = v.getWidth() + "px";
    w.style.height = v.getHeight() + "px";
  ...
  this.wrapComponent = function(a) {
    v.ctatdebug("wrapComponent ()");
    v.makeDivWrapper(a);
    v.ctatdebug("wrapComponent () done");
  };
  this.createCanvas = function() {
    v.ctatdebug("createCanvas ()");
    C = document.createElement("canvas");
    C.setAttribute("id", G);
    C.setAttribute("onkeypress", "return noenter(event)");
    C.setAttribute("width", k + canvasCalibrate + "px");
    C.setAttribute("height", l + canvasCalibrate + "px");
    C.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == A ? "visibility: hidden; " : "") + "z-index:" + F + ";");
    w.firstChild ? w.insertBefore(C, w.firstChild) : w.appendChild(C);
    return C;
  };
  ...
  this.getWidth = function() {
    if (0 >= k) {
      var a;
      p ? a = window.getComputedStyle(p) : w && (a = window.getComputedStyle(w));
      if (a) {
  ...
  this.setEnabled = function(a) {
    v.ctatdebug("setEnabled (" + a + ")");
    v.assignEnabled(a);
    p ? p.disabled = !t : v.ctatdebug("Error: component pointer is null");
  };
  this.lock = this.setEnabled.bind(v, !1);
  this.unlock = this.setEnabled.bind(v, !0);
  ...
  this.setComponent = function(a) {
    p = a;
    p.classList.add("CTAT-gen-component");
  ...
  this.init = function() {
    v.ctatdebug("THIS IS THE BASE INIT METHOD");
  };
  this.initialize = function() {
    v.ctatdebug("initialize ()");
    v.configFromDescription();
    v.init();
    v.processSerialization();
    v.render();
    v.processTabOrder();
    v.ctatdebug("initialize () done");
  };
  this.getInitialized = function() {
    return u;
  };
  this.setInitialized = function(a) {
    v.ctatdebug("setInitialized (" + a + ")");
    u = a;
    !0 !== u || w ? v.ctatdebug("Not wrapping, initialized=" + u + ", divWrapper = " + w) : (v.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (v.ctatdebug("Attaching component to existing MovieClip ..."), v.wrapComponent(a.getDivWrapper())) : (v.ctatdebug("Attaching component to main div ..."), $("#" + ctatcontainer).first() && v.wrapComponent(getSafeElementById(ctatcontainer))));
    v.ctatdebug("setInitialized () done");
  };
  this.addSafeEventListener = function(a, b, d) {
    v.ctatdebug("addSafeEventListener (" + a + ")");
    v.ctatdebug("Adding event listener to: " + d);
    d ? d.addEventListener(a, b) : (p ? (v.ctatdebug("Adding eventlistener to component instead of target"), p.addEventListener(a, b)) : v.ctatdebug("Error: pointer to component is null, can't add event listener"), v.ctatdebug("addSafeEventListener () done"));
  };
  this.drawComponent = function() {
  };
  this.addComponentReference = function(a, b) {
    v.ctatdebug("addComponentReference (" + a.getName() + " -> " + b.getAttribute("id") + ")");
    a.tabIndex = this.getTabIndex();
    CTATComponentReference.add(a, b);
    v.ctatdebug("addComponentReference ()");
  };
  this.getComponentFromID = function(a) {
    return CTATComponentReference.getComponentFromID(a);
  };
  this.processSerialization = function() {
    v.ctatdebug("processSerialization()");
    v.ctatdebug("implement in child class");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    A = !0 === a ? "block" : "hidden";
    C && C.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + f + "px; top:" + h + "px; z-index:" + F + ";");
  ...
  this.processOnFocus = function() {
    v.ctatdebug("processOnFocus (" + v.getName() + ")");
    ...
    CTATGlobals.Tab.Focus != v ? (v.ctatdebug("CTATGlobals.Tab.Focus!=pointer, updating CTATGlobals.Tab.Focus ..."), CTATGlobals.Tab.Focus = v) : v.ctatdebug("CTATGlobals.Tab.Focus==pointer");
    v.ctatdebug("processOnFocus () done");
  };
  this.processFocus = function(a) {
    v.ctatdebug("processFocus ()");
    a.currentTarget.getAttribute("id");
    if (v) {
      mobileAPI && !0 === mobileAPI.getEnabled() && v.hideKeyboard();
      commShell && commShell.processComponentFocus(v);
      if (CTATGlobals.Tab.Focus) {
        v.ctatdebug("old focus: " + CTATGlobals.Tab.Focus.getName() + ", new focus:" + v.getName());
        if (CTATGlobals.Tab.Focus == v) {
          v.ctatdebug("We're already there!");
          return;
        }
        CTATGlobals.Tab.Focus.backgrade && CTATGlobals.Tab.Focus.processAction();
      } else {
        v.ctatdebug("No previously focused component yet, can't grade");
      }
      "hint" == v.getClassName() || "CTATHintButton" == v.getClassName() ? v.ctatdebug("Info: focus moved to hint, bump") : (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = v, v.ctatdebug("processFocus () done"));
    } else {
      v.ctatdebug("Error: component reference is null");
    }
  };
  this.processTabOrder = function() {
    v.ctatdebug("processTabOrder (" + B + ")");
    !0 === q ? v.ctatdebug("Component is an abstract component, bump") : p ? (v.ctatdebug("We have a component, actually assigning to html component ..."), p.tabIndex = B, p.onfocus = v.processOnFocus) : v.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", m = 1, n = CTATGlobals.Visual.BorderColor, q = !1, r = "solid", u = 0, t = "1px", w = 0, x = CTATGlobals.Font.color, B = "black", D = CTATGlobals.Font.family, p = CTATGlobals.Font.size, y = !1, v = !1, C = !1;
  ...
  this.setDisabledTextColor = function(a) {
    B = CTATGlobalFunctions.formatColor(a);
    return this;
  };
  ...
  this.getBorderStyle = function() {
    return this.component ? $(this.component).css("border-style") : r;
  };
  this.setBorderStyle = function(a) {
    r = a;
    this.component && this.getBorderStyle() !== r && (this.component.style.borderStyle = r);
    return this;
  };
  this.getBorderWidth = function() {
    return this.component ? $(this.component).css("borderWidth") : t;
  };
  this.setBorderWidth = function(a) {
    t = parseInt(a);
    isNaN(t) && (t = 0);
    this.component && this.getBorderWidth() !== t && (this.component.style.borderWidth = t);
    return this;
  };
  ...
  this.setFontSize = function(a) {
    a = parseInt(a);
    p = isNaN(a) ? CTATGlobals.Font.size : a;
    this.component && parseInt(this.getFontSize()) !== p && (this.component.style.fontSize = p + "pt");
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    q = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getShowBorder() !== q && (q ? (this.setBorderStyle(r), this.setBorderWidth(t)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getUnderlined = function() {
    return this.component ? "underline" === window.getComputedStyle(this.component).getPropertyValue("text-decoration") : C;
  };
  this.setUnderlined = function(a) {
    C = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getUnderlined() !== C && (this.component.style.textDecoration = C ? "underline" : null);
    return this;
  };
  this.getBolded = function() {
    return this.component ? "bold" === window.getComputedStyle(this.component).getPropertyValue("font-weight") : y;
  };
  this.setBolded = function(a) {
    y = CTATGlobalFunctions.stringToBoolean(a);
    this.component && this.getBolded() !== y && (this.component.style.fontWeight = y ? "bold" : null);
    return this;
  };
  this.getItalicized = function() {
    return this.component ? "italic" === window.getComputedStyle(this.component).getPropertyValue("font-style") : v;
  };
  this.setItalicized = function(a) {
    v = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getItalicized() !== v && (this.component.style.fontStyle = v ? "italic" : null);
    return this;
  };
  var A = this;
  a = function(a) {
    ...
    return {setHandler:function(a, d) {
      ...
      if (b.hasOwnProperty(a)) {
        if (b[a]) {
          ...
          return b[a].apply(A, d);
        }
        A.ctatdebug("Error: NULL handler for " + a);
      } else {
        A.ctatdebug("Error: No handler set for " + a);
      }
    }};
  };
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), f = 0;f < a.length;f++) {
            ...
            var g = document.createElement("div"), u = c.getLevel();
            .95 > u ? g.classList.add("CTAT-skill-window--bar--nonmastered") : g.classList.add("CTAT-skill-window--bar--mastery");
            g.style.width = .95 < u ? "100%" : 100 * u + "%";
            e.appendChild(g);
            b.appendChild(e);
...
var CTATSAI = function(a, b, c, e) {
  function g(a, b, d, f) {
    f = String(u.getElementName(b)).toLowerCase();
    if (f == a || "value" == f) {
      if (f = u.getElementChildren(b), !Array.isArray(f) || 1 > f.length) {
        d.push(u.getNodeTextValue(b));
      } else {
  ...
  var d = "undefined", f = "undefined", h = new CTATStringUtil, k = [], l = [], m = [], n = [], q = [], r = [], u;
  ...
  this.appendToActionArray = function(a) {
    null == a ? q.push("") : q.push(String(a));
  };
  this.setActionArray = function(a) {
    q = null == a ? [] : Array.isArray(a) ? a.slice() : [String(a)];
  };
  this.getActionArray = function() {
    return q;
  };
  this.appendToInputArray = function(a) {
    null == a ? r.push("") : r.push(String(a));
  };
  this.setInputArray = function(a) {
    r = null == a ? [] : Array.isArray(a) ? a.slice() : [String(a)];
  };
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      var f = a[d];
      if ("selection" == u.getElementName(f) || "Selection" == u.getElementName(f)) {
        for (var c = u.getElementChildren(f), e = !1, g = 0;g < c.length;g++) {
          b = c[g], "value" == u.getElementName(b) && (b = u.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = u.getNodeTextValue(f), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == u.getElementName(f) || "Action" == u.getElementName(f)) {
        c = u.getElementChildren(f);
        e = !1;
        for (g = 0;g < c.length;g++) {
          b = c[g], "value" == u.getElementName(b) && (b = u.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = u.getNodeTextValue(f), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == u.getElementName(f) || "value" == u.getElementName(f) || "Input" == u.getElementName(f)) {
        var b = u.getElementChildren(f), l = null;
        k = [];
        c = new CTATHTMLManager;
        e = new CTATArgument;
        g = 0;
        k.push(e);
        for (var h = 0;h < b.length;h++) {
          var m = b[h];
          "value" == u.getElementName(m) && (l = u.getElementChildren(m), null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (l = c.htmlDecode(u.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = c.htmlDecode(u.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(m.attributes.getNamedItem("name").value), e.setType(m.attributes.getNamedItem("type").value), 
          e.setFormat(m.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)) : (m = c.htmlDecode(u.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
      if ("prompt" == u.getElementName(f) || "Prompt" == u.getElementName(f)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(u.getNodeTextValue(f));
      }
    }
    this.checkDefaultArgument();
  };
  this.setArrayFromElements = function(a) {
    if (a && Array.isArray(a) && !(1 > a.length)) {
      var b = null, d = String(u.getElementName(a[0])).toLowerCase();
      switch(d) {
        case "selection":
          b = n = [];
          break;
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == u.getElementName(f) || "Input" == u.getElementName(f)) {
        b = f.childNodes;
        k = [];
        var c = new CTATHTMLManager, e = new CTATArgument, g = 0, l = null;
        k.push(e);
        for (var h = 0;h < b.length;h++) {
          if (l = b[h], "value" == u.getElementName(l)) {
            var m = u.getElementChildren(l);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (l = c.htmlDecode(u.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = c.htmlDecode(u.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(u.getElementAttr("name")), e.setType(u.getElementAttr("type")), e.setFormat(u.getElementAttr("format")), g++)) : (l = c.htmlDecode(u.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + 
            l), e.setValue(l));
  ...
  var t = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(c) || null == c) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(c), t = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == c ? null : c[0], "String", e);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, c, "String", e), t || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(c) ? c : [c]), t = !0));
};
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, f = !1, h = new CTATSkillSet, k = "", l = "", m = "", n = "", q = "", r = null, u = !1;
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == k) {
      ...
      for (c = 0;c < a.length;c++) {
        if (g = a[c], "tool_message" == e.getElementName(g)) {
          for (g = e.getElementChildren(g), l = 0;l < g.length;l++) {
            u = g[l], "event_descriptor" == e.getElementName(u) && (r = new CTATSAI, r.fromXMLInternal(u));
          }
        }
      }
      f = !0;
      ...
      if (d) {
        ...
        for (var v = e.getElementChildren(b), C = 0;C < v.length;C++) {
          var A = v[C];
          if ("event_descriptor" == e.getElementName(A)) {
            for (var A = e.getElementChildren(A), z = 0;z < A.length;z++) {
              var E = A[z];
              "selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), u.push(E));
              "action" == e.getElementName(E) && (c = e.getNodeTextValue(E), p.push(E));
              "input" == e.getElementName(E) && (g = e.getNodeTextValue(E), y.push(E));
              "prompt" == e.getElementName(E) && (l = e.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), v = e.getElementChildren(b), C = 0;C < v.length;C++) {
          if (A = v[C], "properties" == e.getElementName(A)) {
            for (A = e.getElementChildren(A), z = 0;z < A.length;z++) {
              E = A[z], this.ctatdebug("Nodename: " + e.getElementName(E)), "Skills" == e.getElementName(E) && h.parseByValue(E), "SuccessMsg" == e.getElementName(E) && (m = a = e.getNodeTextValue(E)), "BuggyMsg" == e.getElementName(E) && (n = e.getNodeTextValue(E)), "Selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), u.push(E)), "Action" == e.getElementName(E) && (c = e.getNodeTextValue(E), p.push(E)), "Input" == e.getElementName(E) && (g = e.getNodeTextValue(E), y.push(E)), "prompt" == 
              e.getElementName(E) && (l = e.getNodeTextValue(E)), "HighlightMsgText" == e.getElementName(E) && (q = e.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + g);
      "" !== a && null !== a ? (r = new CTATSAI(a, c, g, l), r.setArrayFromElements(u), r.setArrayFromElements(p), r.setArrayFromElements(y), f = !0) : (this.ctatdebug("No SAI found"), f = !1);
  ...
  this.getSAI = function() {
    return f ? r : new CTATSAI;
  };
  this.getSelection = function() {
    return f ? r.getSelection() : "";
  };
  this.getAction = function() {
    return f ? r.getAction() : "";
  };
  this.getInput = function() {
    return f ? r.getInput() : "";
  };
  this.getSelectionArray = function() {
    return f ? r.getSelectionArray() : [];
  };
  this.getActionArray = function() {
    return f ? r.getActionArray() : [];
  };
  this.getInputArray = function() {
    return f ? r.getInputArray() : [];
  };
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    c += "<question_file><![CDATA[" + urldecode(b.question_file) + "]]\x3e</question_file>";
...
CTAT.Component.Base.Tutorable = function(a, b, c, e, g, d, f) {
  ...
  var h = !0, k = !0, l = !0, m = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = !0, q = this, r = !1;
  ...
  var t = CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;
  ...
  this.isCorrect = function() {
    return t === CTAT.Component.Base.Tutorable.Options.Status.CORRECT;
  };
  this.isIncorrect = function() {
    return t === CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;
  };
  this.isNotGraded = function() {
    return t === CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;
  };
  this.setCorrect = function(a) {
    this.setNotGraded();
    "CTATTableGoogle" != this.getClassName() && this.executeSAI(a);
    t = CTAT.Component.Base.Tutorable.Options.Status.CORRECT;
  ...
  this.setIncorrect = function(a) {
    ...
    this.setNotGraded();
    "CTATTableGoogle" != this.getClassName() && this.executeSAI(a);
    t = CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;
  ...
  this.setNotGraded = function() {
    ...
    if (!this.isNotGraded() && (t = CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED, this.removeCorrect(), this.removeInCorrect(), this.component)) {
  ...
  this.setHintHighlight = function(a, b) {
    ...
    0 != a && (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = q, q.component.focus ? CTATGlobals.Tab.Focus.getComponent().focus() : CTATGlobals.Tab.Focus.getDivWrap().focus());
    if (u) {
      ...
      d !== r && (r = d, this.showHintHighlight(d, b));
    }
  };
  ...
  this.resetTutoring = function() {
    ...
    t = CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;
  };
  this.grade = function() {
    this.updateSAI();
...
var CTATImageButtonComponent = function(a, b, c, e, g, d, f) {
  ...
  var h = "", k = "", l = "", m = "", n = !1, q = "Image to Component", r = this;
  ...
  this.assignImages = function(a, b, d, f) {
    r.ctatdebug("assignImages ()");
    h = a;
    k = b;
    l = d;
    m = f;
    null !== r.getComponent() && r.assignActiveImage(h);
  };
  this.assignImageURL = function(a) {
    this.assignImages(a, a, a, a);
  };
  this.assignActiveImage = function(a) {
    if (null !== r.getComponent() && (r.getComponent().src = a, r.getComponent().style.opacity = this.getTransparencyValue(), "Component to Image" == q)) {
      var b = new Image;
      b.src = a;
      r.setWidth(b.width);
  ...
  this.setEnabled = function(a) {
    ...
    r.assignEnabled(a);
    null === r.getComponent() ? r.ctatdebug("Error: pointer is null!") : (r.getComponent().disabled = !a, !1 === r.getEnabled() ? r.assignActiveImage(m) : r.assignActiveImage(h), r.ctatdebug("setEnabled () -> " + r.getEnabled()));
  };
  this.processMouseOver = function(a) {
    !0 !== n && (n = !0, !0 === r.getEnabled() ? r.assignActiveImage(l) : r.ctatdebug("Error component is disabled"), n = !1);
  };
  this.processMouseOut = function(a) {
    !0 !== n && (n = !0, !0 === r.getEnabled() && r.assignActiveImage(h), n = !1);
  };
};
...
var CTATTextBasedComponent = function(a, b, c, e, g, d, f) {
  ...
  var q = this.processAction.bind(this);
  this.processAction = function(a, b) {
    this.updateSAI();
    CTATGlobalFunctions.isBlank(this.getValue()) || q(a, b);
  };
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  var k = "#FF00FF", l = 1, m = "#FF00FF", n = .2, q = "black", r = 1;
  ...
  this.clickHandler = function(a) {
    !0 === t.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), x(this, !a), t.setActionInput("SetPieces", t.updateValue()), t.processAction());
  };
  this.updateSAI = function() {
    t.setActionInput("SetPieces", t.updateValue());
  };
  ...
  this.set_denominator = function(a) {
    t.setHintHighlight(!1);
    var b = "string" === typeof a ? parseInt(a) : a;
    if (!isNaN(b) && (b = y(b), this.get_denominator() != a)) {
      var d = t.evaluate();
      t.clear();
      a = [];
      d.set_denominator(b);
      ...
      t.setActionInput("SetPieces", h);
      t.processAction();
      return h;
    }
  };
  this.get_denominator = function() {
    return u.reduce(function(a, b, d, f) {
  ...
  var v = function(a) {
    if (0 !== Object.keys(C).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        if (a != t) {
          if (C.hasOwnProperty(a.getName())) {
            return C[a.getName()];
          }
          if (C.hasOwnProperty(a.getComponentGroup())) {
            return C[a.getComponentGroup()];
          }
        }
      } else {
        if (a instanceof CTATSAI) {
          if (a.getSelection() != t.getName() && C.hasOwnProperty(a.getSelection())) {
            return C[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != t.getName() && C.hasOwnProperty(a)) {
              return C[a];
            }
          } else {
            if (a instanceof Element && a != t.getComponent() && C.hasOwnProperty(a.id)) {
              return C[a.id];
            }
          }
        }
  ...
  var A = {numerator:{items:[], callback:a.bind(this, this.change_numerator, this.set_numerator)}, denominator:{items:[], callback:a.bind(this, this.change_denominator, this.set_denominator)}, partition:{items:[], callback:a.bind(this, this.change_number_pieces, this.set_number_pieces)}, value:{items:[], callback:function(a) {
    switch(a.getAction()) {
      case "SetPieces":
      ;
      case "UpdateTextField":
...
var CTATFractionBar = function(a, b, c, e, g) {
  ...
  var d = 50, f = !0, h = this, k = CTATGlobals.NameSpace.svg;
  this.init = function() {
    h.initSVG();
    this.baseGroup = document.createElementNS(k, "g");
    this.getComponent().appendChild(this.baseGroup);
    this.getComponent().classList.add("CTAT-fraction-bar");
    this.drawPieces();
    h.addComponentReference(h, h.getDivWrap());
    this.component.addEventListener("focus", this.processFocus);
  };
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = h.parseValue(), b = 0, d = document.createDocumentFragment(), f = 0;f < a.length;f++) {
        var c = a[f], e = 100 * c, g = document.createElementNS(k, "rect");
        g.classList.add("CTAT-fraction-bar--piece");
        g.setAttributeNS(null, "height", "100%");
        g.setAttributeNS(null, "width", e + "%");
        g.setAttributeNS(null, "y", 0);
        g.setAttributeNS(null, "x", b + "%");
        h.addPieceElem(g, c, c.selected);
        b += e;
        d.appendChild(g);
      }
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? f -= d / 2 : (c += d / 2, f = b.x + b.width >= w ? f - d / 2 : f - d);
  ...
  this.setSpacing = function(a) {
    a = Number(a);
    isNaN(a) || (d = a);
  };
  this.setStyleHandler("spacing", this.setSpacing);
  this.setShowFractionLabel = function(a) {
    f = CTATGlobalFunctions.toBoolean(a);
  };
...
var CTATJumble = function(a, b, c, e, g) {
  ...
  this.init = function() {
    ...
    a ? (n.innerHTML = a, $(n).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      this.addEventListener("dragstart", r, !1);
      this.addEventListener("dragenter", t, !1);
      this.addEventListener("dragover", u, !1);
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var d = a.length, f = 0;f < d;f++) {
        ...
        c.addEventListener("dragstart", r, !1);
        c.addEventListener("dragenter", t, !1);
        c.addEventListener("dragover", u, !1);
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  a = function(a, b, f, c) {
    ...
    this.setColor = function(a) {
      this.color = CTATGlobalFunctions.formatColor(a);
    };
    this.setShowLabels = function(a) {
      this.show_labels = CTATGlobalFunctions.toBoolean(a);
    };
    this.setOrgin = function(a) {
      this.orgin = new d(a);
    };
  };
  var h = new a(new d(1), 30, 0, !0);
  this.setLargeTickSize = function(a) {
    h.setSize(s);
  };
  this.setParameterHandler("LargeTickmarkSize", this.setLargeTickSize);
  this.setParameterHandler("LargeTickmarkColor", function(a) {
    h.setColor(a);
  });
  this.setParameterHandler("ShowLargeTickLabels", function(a) {
    h.setShowLabels(a);
  });
  this.setParameterHandler("LargeTickmarkStep", function(a) {
    h.setStep(a);
  });
  var k = new a(new d(1, 2), 20, 0, !0);
  this.setSmallTickSize = function(a) {
    k.setSize(s);
  };
  this.setParameterHandler("SmallTickmarkSize", this.setSmallTickSize);
  this.setSmallTickColor = function(a) {
    k.setColor(a);
  };
  this.setParameterHandler("SmallTickmarkColor", this.setSmallTickColor);
  this.setParameterHandler("ShowSmallTickLabels", function(a) {
    k.setShowLabels(a);
  });
  this.setParameterHandler("SmallTickmarkStep", function(a) {
    k.setStep(a);
  });
  var l = new a(new d(0), 25, "#FF00FF", !1);
  this.setParameterHandler("DenominatorTickmarkSize", function(a) {
    l.setSize(a);
  });
  this.setParameterHandler("DenominatorTickmarkColor", function(a) {
    l.setColor(a);
  });
  var m = new d(3);
  ...
  var q = 1;
  this.setParameterHandler("Max_Points", function(a) {
    q = parseInt(a);
  });
  var r = 7, u = !1;
  this.setParameterHandler("SnapToTickmark", function(a) {
    u = CTATGlobalFunctions.toBoolean(a);
  });
  var t = this;
  this.theta = 0;
  ...
  this.genTickmark = function(a, b, d) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var e = document.createElementNS(f, "line"), g = w.getPosition(a), l = CTAT.Geom.Point.polar(d / 2, t.theta + Math.PI / 2).add(g);
      d = CTAT.Geom.Point.polar(-d / 2, t.theta + Math.PI / 2).add(g);
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            var h = document.createElementNS(f, "tspan"), m = document.createElementNS(f, "tspan");
            ...
            m.setAttributeNS(null, "x", 0);
            m.setAttributeNS(null, "dy", "1em");
            b.length > l.length ? h.style.textDecoration = "underline" : m.style.textDecoration = "overline";
  ...
  var B = function(a) {
    return D(a.step, a.size, a.orgin, a.show_labels ? null : "", a.color);
  }.bind(this), D = function(a, b, c, e, g) {
    g = new d;
    a = new d(a);
    b = "number" === typeof b ? b : 20;
    var l = document.createDocumentFragment(), h = document.createElementNS(f, "g");
    h.setAttributeNS(null, "data-step-size", a.toString());
    h.setAttributeNS(null, "pointer-events", "none");
    h.classList.add("CTAT-number-line--tickmark");
    l.appendChild(h);
    if (0 < a) {
      for (g.set(c).reduce();g <= m;) {
        g >= n && h.appendChild(t.genTickmark(g, e, b)), g = g.add(a);
      }
      g.set(c).reduce();
      for (g = g.subtract(a);g >= n;) {
        g <= m && h.appendChild(t.genTickmark(g, e, b)), g = g.subtract(a);
      }
    }
    return l;
  }.bind(this), p = null, y = function() {
    var a = this.getBoundingBox(), a = CTAT.Geom.Rectangle.inflate(a, -2, -2), b = new DOMPoint(a.width / 2, a.height / 2), d = b.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, t.theta)), c = Math.sin(t.theta), e = -Math.cos(t.theta), g = c * b.x + e * b.y, l = -a.height * e, u = -c * a.width, q = new DOMPoint(a.left, b.y), b = new DOMPoint(a.right, b.y);
    if (0 < Math.abs(CTAT.Math.round(l))) {
      var l = new DOMPoint(a.left, (g - c * a.left) / e), y = new DOMPoint(a.right, (g - c * a.right) / e);
      if (a.contains(l) || a.contains(y)) {
        d.distance(l) < d.distance(y) ? (q = y, b = l) : (q = l, b = y);
      }
    }
    0 < Math.abs(CTAT.Math.round(u)) && (u = new DOMPoint((g - e * a.top) / c, a.top), c = new DOMPoint((g - e * a.bottom) / c, a.bottom), a.containsPoint(u) || a.containsPoint(c)) && (d.distance(u) < d.distance(c) ? (q = c, b = u) : (q = u, b = c));
    a = document.createDocumentFragment();
    d = document.createElementNS(f, "g");
    d.classList.add("CTAT-number-line--axis");
    a.appendChild(d);
    c = document.createElementNS(f, "line");
    c.setAttributeNS(null, "x1", q.x);
    c.setAttributeNS(null, "y1", q.y);
    c.setAttributeNS(null, "x2", b.x);
    c.setAttributeNS(null, "y2", b.y);
    d.appendChild(c);
    w = new x(q, b, n, m);
    c = document.createElementNS(f, "path");
    c.setAttributeNS(null, "d", "M 10,6 L 0,0 L 10,-6");
    c.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(q) + ") rotate(" + t.getOrientation() + ")");
    d.appendChild(c);
    q = document.createElementNS(f, "path");
    q.setAttributeNS(null, "d", "M -10,6 L 0,0 L -10,-6");
    q.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(b) + ") rotate(" + t.getOrientation() + ")");
    d.appendChild(q);
    this._tickmarks = [];
    a.appendChild(B(h));
    a.appendChild(B(k));
    p = document.createElementNS(f, "circle");
    p.classList.add("CTAT-number-line--cursor");
    p.setAttributeNS(null, "r", r);
    p.setAttributeNS(null, "transform", "translate(-30,-30)");
    a.appendChild(p);
    t.baseGroup.innerHTML = "";
    t.baseGroup.appendChild(a);
    q = this.theta + Math.PI / 2;
    CTAT.Geom.Point.polar(3, q);
    CTAT.Math.round(Math.cos(q));
    CTAT.Math.round(Math.sin(q));
    v = document.createElementNS(f, "g");
    v.setAttributeNS(null, "fill", "black");
    v.setAttributeNS(null, "stroke-width", 1);
    v.setAttributeNS(null, "stroke", "black");
    this.baseGroup.appendChild(v);
  }.bind(this), v = null, C = 0, A = new DOMPoint(-30, -30), z = !1, E = function(a) {
    A.x = a.clientX;
    A.y = a.clientY;
  }, F = function(a) {
    ...
    if (!0 === t.getEnabled()) {
      t.setHintHighlight(!1);
      var b;
      u ? (b = H(a.clientX, a.clientY), a = b.location, b = b.data) : (b = J(a.clientX, a.clientY), a = w.getProjectedPoint(b), b = w.getAxisValue(b));
      var d = document.createDocumentFragment(), c = document.createElementNS(f, "circle");
      c.setAttributeNS(null, "r", r);
      c.setAttributeNS(null, "cx", a.x);
      c.setAttributeNS(null, "cy", a.y);
      c.value = b;
      d.appendChild(c);
      v.innerHTML = "";
      v.appendChild(d);
      t.setActionInput("AddPoint", b.toString());
      t.processAction();
    }
  };
  this.init = function() {
    this.initSVG();
    this.getComponent().classList.add("CTAT-number-line");
    this.baseGroup = document.createElementNS(f, "g");
    this.getComponent().appendChild(this.baseGroup);
    y();
    t.addComponentReference(t, t.getDivWrap());
    t.addSafeEventListener("mousemove", E);
    t.addSafeEventListener("mouseleave", F);
    t.addSafeEventListener("mouseenter", function() {
      !0 === t.getEnabled() && (z = !0, p.style.fillOpacity = null, C = requestAnimationFrame(L));
    });
    t.addSafeEventListener("click", G);
    this.component.addEventListener("focus", this.processFocus);
  };
  var J = function(a, b) {
    this.svgPoint = this.svgPoint ? this.svgPoint : t.getComponent().createSVGPoint();
    this.svgPoint.x = a;
    this.svgPoint.y = b;
    var d = t.getComponent().getScreenCTM().inverse();
    this.svgPoint = this.svgPoint.matrixTransform(d);
    return new DOMPoint(this.svgPoint.x, this.svgPoint.y);
  }, H = function(a, b) {
    for (var d = w.getProjectedPoint(J(a, b)), f = null, c = Number.POSITIVE_INFINITY, e, g, l = 0;l < t._tickmarks.length;l++) {
      e = t._tickmarks[l], g = d.distance(e.location), g < c && (f = e, c = g);
    }
    return f;
  }, L = function() {
    if (z && !0 === t.getEnabled()) {
      if (u) {
        var a = H(A.x, A.y);
        p.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(a.location, !0));
      } else {
        p.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(w.getProjectedPoint(J(A.x, A.y)), !0));
      }
  ...
  this.placePointByNum = function(a) {
    a = t.calcXCoordinate(a);
    return t.placePointByCoor(a);
  };
  this.calcXCoordinate = function(a) {
    a = new d(a);
    var b = t.getWidth() - 30, b = Math.abs(b - 30), f = m.subtract(n);
    return 30 + a.subtract(n).divide(f) / b;
  };
  this.calcNum = function(a) {
    var b = t.getWidth() - 30, b = Math.abs(b - 30);
    a = m.subtract(n).multiply((a - 30) / b);
    return n.add(a);
  };
  this.setTickStepL = function(a) {
    h.setStep(a);
  };
  this.setTickStepS = function(a) {
    k.setStep(a);
  };
  this.setMax = function(a) {
    m = new d(a);
  };
  this.setMin = function(a) {
    n = new d(a);
  };
  this.setPointSize = function(a) {
    r = Number(a);
    p && (p.setAttributeNS(null, "r", r), v.setAttributeNS(null, "r", r));
  };
  this.setStyleHandler("PointSize", this.setPointSize);
  this.setMaxPoints = function(a) {
    var b = parseInt(a);
    isNaN(b) || (q = parseInt(a));
  };
  ...
  this.set_precision = function(a) {
    t.setPrecision(parseInt(a));
    t.render();
  };
  this.Points = function(a) {
    a = a.split(";");
    for (var b = 0;b < a.length;b++) {
      t.placePointByNum(a[b]);
    }
  };
  this.set_denominator = function(a) {
  };
...
var CTATPieChart = function(a, b, c, e, g) {
  ...
  var d = 3, f = 3, h = 3, k = this, l, m, n, q = null, r = CTATGlobals.NameSpace.svg;
  this.init = function() {
    k.initSVG();
    this.baseGroup = document.createElementNS(r, "g");
    this.getComponent().appendChild(this.baseGroup);
    this.getComponent().classList.add("CTAT-pie-chart");
    l = document.createElementNS(r, "filter");
    l.id = this.genName("Shadow");
    m = "#" + l.id;
    n = "url(" + m + ")";
    l.setAttributeNS(null, "width", "200%");
    l.setAttributeNS(null, "height", "200%");
    q = document.createElementNS(r, "feOffset");
    q.setAttributeNS(null, "in", "SourceAlpha");
    q.setAttributeNS(null, "result", "offOut");
    q.setAttributeNS(null, "dx", h);
    q.setAttributeNS(null, "dy", h);
    l.appendChild(q);
    var a = document.createElementNS(r, "feGaussianBlur");
    a.setAttributeNS(null, "in", "offOut");
    a.setAttributeNS(null, "result", "blurOut");
    a.setAttributeNS(null, "stdDeviation", 4);
    l.appendChild(a);
    a = document.createElementNS(r, "feBlend");
    ...
    this.baseGroup.setAttributeNS(null, "filter", n);
    this.drawPieces();
    k.addComponentReference(k, k.getDivWrap());
    this.component.addEventListener("focus", this.processFocus);
  };
  this.drawPieces = function() {
    if (this.baseGroup) {
      var a = window.getComputedStyle(k.getComponent()), a = parseFloat(a.getPropertyValue("stroke-width")), b = this.getBoundingBox(), c = Math.min(b.width / 2, b.height / 2) - (a + h + 4), f = new DOMPoint(b.width / 2, b.height / 2), a = k.parseValue(), e = document.createDocumentFragment();
      a.reduce(function(a, b, g, l) {
        if (1 <= b.valueOf()) {
          g = document.createElementNS(r, "circle"), g.classList.add("CTAT-pie-chart--piece"), g.cx.baseVal.value = f.x, g.cy.baseVal.value = f.y, g.r.baseVal.value = c, k.addPieceElem(g, b, b.selected), e.appendChild(g);
        } else {
          g = document.createElementNS(r, "path");
          g.classList.add("CTAT-pie-chart--piece");
          e.appendChild(g);
          window.getComputedStyle(g);
          var h = 2 * Math.PI * a.valueOf();
          l = f.add(CTAT.Geom.Point.polar(c, h));
          b.reduce();
          var m = f.add(CTAT.Geom.Point.polar(c, 2 * Math.PI * b.valueOf() + h)), n = f.clone();
          if (0 < d && d < c) {
            h = CTAT.Geom.Point.polar(d, h + Math.PI * b.valueOf());
            n = n.add(h);
            l = l.add(h);
            var u = function(a, b, d) {
              return a.distance(b) < a.distance(d) ? b : d;
            };
            l = CTAT.Geom.Point.circle_intersection(n, l, f, c).reduce(u.bind(this, l));
            m = m.add(h);
            m = CTAT.Geom.Point.circle_intersection(n, m, f, c).reduce(u.bind(this, m));
          }
          h = CTAT.Geom.Point.to2DString;
          n = "M " + h(n);
          u = new DOMPoint(c, c);
          n += " L " + h(l);
          n += " A " + h(u) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + h(m);
          g.setAttributeNS(null, "d", n + " Z");
          k.addPieceElem(g, b, b.selected);
        }
        return a.add(b);
      }, new CTAT.Math.Fraction);
      this.baseGroup.innerHTML = "";
      this.baseGroup.appendChild(e);
    }
  };
  ...
  this.setBorderPadding = function(a) {
    var b = Number(a);
    isNaN(b) || (b = b != f, f = a, b && this.drawPieces());
  };
  this.setDropShadowDistance = function(a) {
    h = parseInt(a);
    h = isNaN(h) ? 0 : h;
    q && (q.setAttributeNS(null, "dx", h), q.setAttributeNS(null, "dy", h), 0 >= h && this.baseGroup && this.baseGroup.removeAttributeNS(null, "filter"));
  };
};
...
var CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (v.ctatdebug("errScrimUp (" + a + ")"), 1 == g ? 1 == r && (r = !1, getSafeElementById(ctatcontainer).removeChild(p)) : 1 == f && (r = !0), v.scrimUp(a));
  }
  function c(a, b) {
    v.ctatdebug("makeHTMLButton ()");
    var d = document.createElement("input");
    d.type = "button";
    d.value = b;
    null != a ? (v.ctatdebug("clickHandle!=null"), d.onclick = a) : (v.ctatdebug("clickHandle==null"), d.onclick = v.defaultClickHandler);
    d.id = b;
    d.setAttribute("class", "scrimButton");
    return d;
  }
  CTATBase.call(this, "CTATScrim", "__undefined__");
  var e = !1, g = !1, d = !0, f = !1, h = !1, k = !0, l = !0, m = "", n = !1, q = !1, r = !1, u = null, t = null, w = new CTATCanvasComponent("CTAT Scrim"), x = [], B = null, D = null, p = null, y = null, v = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (v.ctatdebug("scrimUp ()"), v.ctatdebug("Message: " + b), 1 == e ? (m = 1 == d ? b : m + (" \n " + b), w.removeComponent()) : (m = b, e = !0), v.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        v.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + m + "<br><br></div></div></div>\t\t"), !0 === r && (p = c(a, "close"), $(p).appendTo("#scrimpanel")), !0 === n && (B = c(u, "yes"), $(B).appendTo("#scrimpanel")), !0 === q && (D = c(t, "no"), $(D).appendTo("#scrimpanel")), 
        1 == d)) {
          ...
          try {
            ...
            (g instanceof ReferenceError || g instanceof TypeError) && console.log('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', g, typeof g);
          }
        }
      }
    }
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (v.ctatdebug("waitScrimUp ()"), d = !0, v.scrimUp(CTATGlobals.languageManager.getString("LOADING")));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (v.ctatdebug("nextProblemScrimUp ()"), v.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (v.ctatdebug("OKScrimUp (" + a + "," + b + ")"), v.scrimUp(a), y = c(b, spaceUsedUp, "OK"), $(y).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (v.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), q = n = !0, t = d, u = b, v.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == k ? (v.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), x.push("ERROR: " + a), g = !0) : 0 == l ? v.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (g = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == k ? (v.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), x.push("WARNING: " + a), f = !0) : 0 == l ? v.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (f = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    h = !0;
    v.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"));
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == e ? v.ctatdebug("The scrim isn't up, returning") : 1 == g ? v.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == f ? v.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == h ? v.ctatdebug("The scrim is up for a connection issue leave it up!") : ($("#scrim").remove(), w.removeComponent(), d = e = !1, m = ""));
  };
  this.defaultClickHandler = function() {
    v.ctatdebug("defaultClickHandler ()");
    v.scrimDown();
  };
  this.setInAuthorTime = function(a) {
    v.ctatdebug("setting inAuthorTime = " + a);
    k = !0;
    l = a;
    if (!a) {
      f = g = !1, r && null.removeChild(p);
    } else {
      if (g || f) {
        for (var d in x) {
          b(d);
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var e = "", g = 0, d = [], f = a ? a : null, h = null == b ? !0 : b, k = !0, l = null, m = c ? c : {}, n = this;
  ...
  this.createConnection = function(a) {
    n.ctatdebug("createConnection ()");
    return "websocket" == flashVars.getRawFlashVars().tutoring_service_communication ? new CTATWSConnection(a) : new CTATConnection(a);
  };
  ...
  this.getURL = function() {
    ...
    "https" == a.tutoring_service_communication && (b = "https://");
  ...
  this.sendXML = function(a) {
    ...
    if (1 == useBundling && 1 == inBundle) {
      ...
      bundleFormatter = a;
      a = flashVars.getRawFlashVars();
      var b = this.getURL(), d = bundleFormatter;
      -1 == bundleFormatter.indexOf("<?xml") && (d = '<?xml version="1.0" encoding="UTF-8"?>' + bundleFormatter);
      1 == this.getUseCommSettings() ? "javascript" == a.tutoring_service_communication ? CTAT.ToolTutor.sendToTutor(d) : this.send_post(b, d) : this.send_post(b, d);
    }
  };
  ...
  this.sendXMLURL = function(a, b) {
    ...
    1 == this.getUseCommSettings() ? "javascript" == c.tutoring_service_communication ? CTAT.ToolTutor.sendToTutor(d) : this.send_post(b, d) : this.send_post(b, d);
  };
  ...
  this.send_post_variables = function(a, b) {
    ...
    var d = "", d = 0 == useOLIEncoding ? this.encodeVariables(b) : this.encodeVariablesOLI(b);
    this.ctatdebug("Sending: " + d);
    this.send_post(a, d);
  };
  this.send_post = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var c = n.createConnection(m);
      c.setID(g);
      g++;
      if (null === c.getHTTPObject()) {
        return alert("Cannot create XMLHTTP instance"), !1;
      }
      d.push(c);
      n.ctatdebug(b);
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, e = !1, g = !1, d = [], f = "undefined", h = "undefined", k = "undefined", l = "undefined", m = "undefined", n = "undefined", q = "undefined", r = "undefined", u = "UnassignedDataset", t = "UnassignedLevelName", w = "UnassignedLevelType", r = (new CTATGuid).guid();
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), components:{}, component_descriptions:{}, registerComponentDescription:function(a) {
  ...
  var c = CTATShellTools.ctat_base;
  CTATShellTools.ctat_base.ctatdebug("findComponent(" + a + ")");
  var e = CTATShellTools.component_descriptions, g = [], d = null, d = -1 < a.indexOf(".") ? $('[id="' + a + '"]') : $("#" + a);
  if (0 < d.length) {
    var f = [];
    d.each(function() {
  ...
  if (0 < d.length) {
    var h = [];
    d.each(function() {
      $(this).data("CTATComponent") && h.push($(this).data("CTATComponent"));
    });
    if (0 < h.length) {
      return h;
    }
  ...
  for (var k in e) {
    d = e[k];
    if (null === d) {
      return c.ctatdebug("Internal error parsing component at index " + k), null;
    }
    if (null === d.name) {
      return c.ctatdebug("Internal error parsing component at index " + k + " (no name attribute available)"), null;
    }
    if (d.name == a) {
      if (null == d.getComponentPointer()) {
        return c.ctatdebug("Internal error, found a component description for [" + d.name + "], but component pointer is null"), null;
      }
      c.ctatdebug("Found a component description for [" + d.name + "], returning pointer (" + d.getComponentPointer() + ") ...");
      g = [];
      g.push(d.getComponentPointer());
      return g;
    }
    d.groupName == a && (c.ctatdebug("Found the component group (" + d.groupName + "), adding component instance for " + d.name + " ..."), g.push(d.getComponentPointer()));
  }
  return null === g ? (c.ctatdebug("Info (groupArray==null), no appropriate component found, perhaps this is a group component"), -1 != a.indexOf(".") ? (c = a.split("."), this.findComponent(c[0])) : g) : 0 === g.length && (c.ctatdebug("Info (groupArray.length==0), no appropriate component found, perhaps this is a group component"), -1 != a.indexOf(".")) ? (c = a.split("."), this.findComponent(c[0])) : g;
}, findComponentByClass:function(a) {
  var b = CTATShellTools.ctat_base;
  b.ctatdebug("findComponentByClass(" + a + ")");
  var c = CTATShellTools.component_descriptions, e;
  for (e in c) {
    var g = c[e];
    if (null === g) {
      return b.ctatdebug("Internal error parsing component at index " + e), null;
    }
    if (null !== g.getComponentPointer() && g.getComponentPointer().getClassName() == a) {
      return b.ctatdebug("Found a component description, returning pointer ..."), g.getComponentPointer();
    }
  }
  a = $("." + a);
...
var CTATMessageHandler = function() {
          ...
          if ("MessageType" == e.getElementName(n)) {
            ...
            if ("StartStateEnd" == n) {
              ...
              try {
                ...
                b.ctatdebug("Caught in the act: " + B.message);
              }
              inStartState = !1;
            }
            ...
            if ("AssociatedRules" == n) {
              ...
              for (var q = "", r = "", u = 0;u < l.length;u++) {
                var t = l[u];
                "TutorAdvice" == e.getElementName(t) && (q = e.getNodeTextValue(t));
                "Actor" == e.getElementName(t) && e.getNodeTextValue(t);
                "Indicator" == e.getElementName(t) && (r = e.getNodeTextValue(t));
                "StepID" == e.getElementName(t) && e.getNodeTextValue(t);
                "LogAsResult" == e.getElementName(t) && e.getNodeTextValue(t);
                "tool_selection" == e.getElementName(t) && e.getNodeTextValue(t);
                "Skills" == e.getElementName(t) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(t));
              }
              a.processAssociatedRules(f, r, q);
            }
            ...
            if ("ShowHintsMessage" == n) {
              ...
              for (u = 0;u < l.length;u++) {
                if (t = l[u], "HintsMessage" == e.getElementName(t)) {
                  for (var t = e.getElementChildren(t), w = 0;w < t.length;w++) {
                    var x = t[w];
                    "value" == e.getElementName(x) && (r.push(e.getNodeTextValue(x)), q = !0);
                  }
                }
              }
              !0 === q ? a.processHintResponse(f, r) : b.ctatdebug("Error: incomplete hint message received");
            }
    ...
    if (void 0 === d || null === d) {
      ...
      if (b.ctatdebug("Processing node: " + d.nodeName), null === e.getElementChildren(d)) {
        ...
        for (var c = 0;c < d.length;c++) {
          ...
          "confirmDone" == e.getElementName(g) && (b.ctatdebug("Confirm done: " + e.getNodeTextValue(g)), "false" == e.getNodeTextValue(g) && (confirmDone = !1), "true" == e.getNodeTextValue(g) && (confirmDone = !0));
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", g = "Unknown", k = null, l = 0;l < a.length;l++) {
      ...
      if ("serialized" == e.getElementName(m)) {
        ...
        for (var n = e.getElementChildren(m), q = 0;q < n.length;q++) {
          var r = n[q];
          -1 != e.getElementName(r).indexOf("CTAT") && (k = r);
        }
      }
  ...
  this.deserializeComponent = function(a, c, g) {
    ...
    if (null === e.getElementAttr(g, "x")) {
      ...
      var k = e.getElementAttr(g, "x"), l = e.getElementAttr(g, "y"), m = e.getElementAttr(g, "width"), n = e.getElementAttr(g, "height"), q = e.getElementAttr(g, "tabIndex"), r = e.getElementAttr(g, "zIndex");
      null === q && (q = -1);
      null === r && (r = 0);
      var u = new CTATComponentDescription;
      u.type = a;
      u.name = c;
      u.x = Math.floor(k);
      u.y = Math.floor(l);
      u.tabIndex = q;
      u.zIndex = r;
      u.width = Math.floor(m);
      u.height = Math.floor(n);
      CTATShellTools.registerComponentDescription(u);
      ...
      for (k = 0;k < g.length;k++) {
        ...
        if ("Parameters" == e.getElementName(l)) {
          for (this.ctatdebug("Processing component parameters ..."), m = e.getElementChildren(l)[0], m = e.getElementChildren(m), n = 0;n < m.length;n++) {
            var t = m[n];
            if ("CTATComponentParameter" == e.getElementName(t)) {
              this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
              for (var r = q = void 0, t = e.getElementChildren(t), w = 0;w < t.length;w++) {
                var x = t[w];
                "name" == e.getElementName(x) && (this.ctatdebug("Found parameter name: " + e.getNodeTextValue(x)), q = e.getNodeTextValue(x));
                "value" == e.getElementName(x) && (this.ctatdebug("Found parameter value: " + e.getNodeTextValue(x)), r = e.getNodeTextValue(x).trim());
              }
              this.ctatdebug("Parameter name: " + q + ", value: " + r);
              void 0 !== q && (u.params[q] = r, "group" == q && (u.groupName = r));
            }
          }
        }
        if ("Styles" == e.getElementName(l)) {
          for (this.ctatdebug("Processing component styles ..."), l = e.getElementChildren(l)[0], l = e.getElementChildren(l), m = 0;m < l.length;m++) {
            if (r = l[m], "CTATStyleProperty" == e.getElementName(r)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              q = n = "";
              r = e.getElementChildren(r);
              for (t = 0;t < r.length;t++) {
                w = r[t], "name" == e.getElementName(w) && (n = e.getNodeTextValue(w)), "value" == e.getElementName(w) && (q = e.getNodeTextValue(w).trim());
              }
              this.ctatdebug("Style (name: " + n + ", value: " + q + ")");
              "" !== n && (u.styles[n] = q);
            }
          }
        }
...
var CTATCheckBox = function(a, b, c, e, g) {
  ...
  this.init = function() {
    ...
    l.addSafeEventListener("focus", l.processFocus, d);
    this.setSelection(this.getComponentGroup());
  };
  var n = this.setText;
  this.setText = function(a) {
...
var CTATHintWindow = function(a, b, c, e, g) {
  ...
  var d = this;
  d.isTabIndexable = !1;
  var f = null, h = null, k = null, l = null, m = CTATGlobals.languageManager.getString("NEXT"), n = CTATGlobals.languageManager.getString("PREVIOUS"), q = null;
  ...
  this.init = function() {
    ...
    if (r) {
      h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), h.innerHTML = r;
    } else {
      if (u) {
...
var CTATRadioButton = function(a, b, c, e, g) {
  ...
  this.showCorrect = function(a) {
    r("CTAT--hint");
    r("CTAT--incorrect");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? q("CTAT--correct") : r("CTAT-correct");
  };
  this.removeCorrect = function() {
    r("CTAT--correct");
  };
  this.showInCorrect = function(a) {
    r("CTAT--hint");
    r("CTAT--correct");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? q("CTAT--incorrect") : r("CTAT-incorrect");
  };
  this.removeInCorrect = r.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    this.removeCorrect();
    this.removeInCorrect();
    a ? q("CTAT--hint") : r("CTAT--hint");
  };
};
...
var CTATCurriculumService = function(a) {
  ...
  this.sendSummary = function(e) {
    ...
    var g = new CTATXML;
    e = e.getXMLObject();
    var d = e.getElementsByTagName("ProblemSummary"), d = $("<div>").html(d[0].innerHTML).text(), f = g.xmlToString(e);
    e = flashVars.getRawFlashVars();
    var g = e.curriculum_service_url, h = new CTATXML, d = h.parse(d), d = h.getElementAttr(d, "CompletionStatus");
    g ? ("complete" == d && CTATScrim.scrim.nextProblemScrimUp(), b = [], this.addVariable("user_guid", e.user_id), this.addVariable("session_id", e.session_id), this.addVariable("authenticity_token", e.authenticity_token), this.addVariable("school_name", e.school_name), this.addVariable("summary", encodeURIComponent(f)), this.addVariable("problem_state", ""), d = e.target_frame, e = e.reuse_swf, this.addVariable("targetFrame", d), this.addVariable("reuseSWF", e), c.ctatdebug("TargetFrame = " + d + 
    " reuseSwf " + e), a.send_post_variables(g, b)) : "complete" == d && CTATScrim.scrim.scrimUp("Congratulations, you are done with this problem.");
  };
...
var CTATCommShell = function() {
  ...
  this.focusNextComponent = function(a) {
    this.ctatdebug("focusNextComponent ()");
    null !== CTATGlobals.Tab.Focus && (CTATGlobals.Tab.Focus instanceof CTAT.Component.Base.Tutorable || CTATGlobals.Tab.Focus instanceof CTATCompBase) && CTATGlobals.Tab.Focus.setHintHighlight(!1, null, null);
    var b = a.getTabIndex(), d = null;
    b++;
    this.ctatdebug("Finding next component with tab index: " + b + " or higher, examining " + Object.keys(CTATShellTools.component_descriptions).length + " components ...");
    for (var c in CTATShellTools.component_descriptions) {
      var f = CTATShellTools.component_descriptions[c].getComponentPointer();
      null != f ? f.getTabIndex() == b && (this.ctatdebug("Found a candidate component for new focus"), d = f) : this.ctatdebug("Error: component pointer is null");
    }
    if (null == d) {
      this.ctatdebug("Internal error, unable to resolve currentComponentPointer");
    } else {
      if ("hint" === d.getName() || "CTATHintButton" == d.getClassName()) {
        d.getComponent().focus();
      } else {
        if (this.ctatdebug("From: " + a.getName() + ", to: " + d.getName()), d.getComponent() && d.getComponent() instanceof HTMLElement) {
          return d.getComponent().focus(), !0;
        }
      }
    }
    return !1;
  ...
  this.gradeComponent = function(a) {
    ...
    var d = CTATShellTools.findComponentByClass("CTATDoneButton");
    null != d && d != a ? d.setHintHighlight(!1, null, null) : b.ctatdebug("Info: no done button available to reset");
  ...
  this.processInterfaceAction = function(a) {
    ...
    0 == inStartState ? (b.ctatdebug("This is not a start state TPA so it should be logged", "commShell"), null != commLoggingLibrary ? commLoggingLibrary.logSemanticEvent(a.getTransactionID(), a.getSAI(), "ATTEMPT", a.getProperty("subtype")) : this.ctatdebug("Info: no logging library available!")) : b.ctatdebug("Info for incoming TPA, commMessageHandler.getInStartState (): " + commMessageHandler.getInStartState());
    ...
    if (null != c) {
      if (c = c.getSelection(), null != c) {
        if (b.ctatdebug("Highlighting selection for hint: " + c), c = CTATShellTools.findComponent(c), null != c) {
          for (var f = 0;f < c.length;f++) {
            1 == detailedFeedback && c[f].setHintHighlight && c[f].setHintHighlight(!0, null, a);
          }
        } else {
  ...
  this.showHighlightSelection = function(a, d) {
    ...
    if (null != c) {
      for (var f = 0;f < c.length;f++) {
        1 == detailedFeedback && c[f].setHintHighlight(!0, null, d);
      }
    } else {
      b.ctatdebug("Unable to find component name in list: " + c);
    }
...
CTATTutor.runTutor = function(a) {
  ctatdebug("runTutor ()");
  !0 === CTATGlobals.tutorRunning ? ctatdebug("The tutor is already running") : (skillSet = new CTATSkillSet, null == flashVars && (flashVars = new CTATFlashVars, flashVars.assignRawFlashVars(a)), window.onerror = function(a, c, e) {
...
function initTutor(a, b, c, e) {
  ctatdebug("initTutor() #FlashVars " + (a ? a.length : null) + ", usingFlash " + e);
  ...
  "javascript" == String(b.tutoring_service_communication).toLowerCase() && (CTATExampleTracer ? CTAT.ToolTutor.registerTutor(new CTATExampleTracer) : CTATScrim.scrim.warningScrimUp('Tutoring service communication parameter is "JavaScript" but class\nCTATExampleTracer is missing. Use a different ctat-*.js script.'));
  ctatdebug("initTutor ()");
...
function prepTutorArea() {
  "on" == parseQueryString().AUTORUN ? initTutor() : new CTATPlayButton;
}
...
(function(a) {
  ...
  b.format = function(a, d) {
    var f = 1, h = a.length, k = "", l = [], m, q, y, v, C = !0, A = "";
    for (m = 0;m < h;m++) {
      if (k = c(a[m]), "string" === k) {
        l[l.length] = a[m];
      } else {
        if ("array" === k) {
          y = a[m];
          if (y[2]) {
            for (k = d[f], q = 0;q < y[2].length;q++) {
              if (!k.hasOwnProperty(y[2][q])) {
                throw Error(b("[sprintf] property '%s' does not exist", y[2][q]));
              }
              k = k[y[2][q]];
            }
          } else {
          ...
          "function" == c(k) && (k = k());
          if (e.test(y[8]) && "number" != c(k) && isNaN(k)) {
          ...
          switch(y[8]) {
            ...
            case "d":
              ...
              break;
            case "e":
              k = y[7] ? k.toExponential(y[7]) : k.toExponential();
              break;
            case "f":
              k = y[7] ? parseFloat(k).toFixed(y[7]) : parseFloat(k);
              break;
            case "o":
              k = k.toString(8);
              break;
            case "s":
              k = (k = String(k)) && y[7] ? k.substring(0, y[7]) : k;
              break;
            case "u":
              k >>>= 0;
              break;
          ...
          if (!C || g.test(y[8]) && y[3]) {
            A = C ? "+" : "-", k = k.toString().replace(n, "");
          }
          q = y[4] ? "0" == y[4] ? "0" : y[4].charAt(1) : " ";
          v = y[6] - (A + k).length;
          v = y[6] ? Array(v + 1).join(q) : "";
          l[l.length] = y[5] ? A + k + v : 0 == q ? A + v + k : v + A + k;
        }
      }
    }
    return l.join("");
        ...
        if (null !== (b = f.exec(a))) {
          ...
          if (null !== (b = h.exec(a))) {
            if (b[2]) {
              var e = e | 1, g = [], n = b[2], q = [];
              if (null !== (q = k.exec(n))) {
                for (g[g.length] = q[1];"" !== (n = n.substring(q[0].length));) {
                  if (null !== (q = l.exec(n))) {
                    g[g.length] = q[1];
                  } else {
                    if (null !== (q = m.exec(n))) {
  ...
  "undefined" !== typeof exports ? (exports.sprintf = b, exports.vsprintf = q) : (a.sprintf = b, a.vsprintf = q, "function" === typeof define && define.amd && define(function() {
    return {sprintf:b, vsprintf:q};
  }));
...
var CTATExampleTracerSkill = function(a, b, c, e, g, d) {
  ...
  var f = null == a || "" == a.trim() ? b : b + " " + a, h = e, k = 0, l = 0, m = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, n = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, q = null, r = this;
  this.getSkillName = function() {
    return f;
  };
  this.getCategory = function() {
  ...
  this.getLabel = function() {
    return null === q || "undefined" === typeof q || 1 > q.length ? CTATExampleTracerSkill.getName(f) : q;
  };
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var e = Number.MAX_VALUE, g = b, d = 0, f = new Date, h = {}, k = 0, l = 0, m = 0, n = 0, q = 0, r = 0, u = 0, t = CTATMsgType.CompletionValue[0], w = this;
  ...
  this.toXML = function(b) {
    var c;
    c = "" + (' ProblemName="' + a + '"');
    c += ' CompletionStatus="' + t + '"';
    c += ' Correct="' + k + '"';
    c += ' UniqueCorrect="' + q + '"';
    c += ' UniqueCorrectUnassisted="' + r + '"';
    c += ' Hints="' + l + '"';
    c += ' UniqueHints="' + n + '"';
  ...
  this.addError = function(a) {
    ...
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++u, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), h[a] = b, u++);
    m++;
  ...
  this.addCorrect = function(a) {
    ...
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++q, 1 > b.getNFirstHints() && r++), b.incrementNCorrect()) : (w.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, q++, r++);
    k++;
  ...
  this.setCompletionStatus = function(a, b) {
    ...
    if (CTATMsgType.CompletionValue[1] != t || b) {
      t = a;
    }
  };
...
var CTATDefaultGroupModel = function() {
  ...
  function c(a, b) {
    ...
    var d = null, c = !1, f = null;
    k.getGroupSubgroups(b).forEach(function(b) {
      !0 !== c && !0 === k.isLinkInGroup(b, a) && (d = k.getImmediateGroupOfLink(a, b), f = null !== d && "undefined" !== typeof d ? d : b, c = !0);
    });
    return !0 === c ? f : null;
  }
  function e(a, b) {
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (e && a) {
      ...
      if (CTATBase.inOLI()) {
        ...
        k.session_id = encodeURIComponent(a.getSessionID()), k.authenticity_token = encodeURIComponent(g), k.summary = encodeURIComponent(h.toXML(!1));
      }
      ...
      if (CTATBase.inXBlock()) {
        setVariable("saveandrestore", k.problem_state), gradeStudent("percentScore", String(k.percentScore));
      } else {
        if (CTATBase.inOLI()) {
...
(function() {
  ...
  a = function(a) {
    ...
    c.prototype.distributeFactors = function(a) {
      ...
      a.slice(1).forEach(function(a) {
        ...
        return a.addition() ? 1 === b.length ? b = a.terms.map(function(a) {
          var d;
          d = b[0].map(function(a) {
            return a.clone();
          });
          a.multiplication() ? d.push.apply(d, a.pushNegation().factors) : d.push(a);
          return d;
          ...
          return b;
        }, []) : 1 === b.length ? a.multiplication() ? (d = b[0]).push.apply(d, a.pushNegation().factors) : b[0].push(a) : b.forEach(function(d, c) {
          var e;
          return a.multiplication() ? (e = b[c]).push.apply(e, a.pushNegation().factors.map(function(a) {
            return a.clone();
          })) : b[c].push(a.clone());
        });
      });
    ...
    c.prototype.compare = function(a, b) {
      var e, k;
      return (k = c.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (e = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, d) {
        return k = a.compare(e[d], b);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], e = [1, 7], g = [1, 10], d = [1, 11], f = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], m = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], q = [1, 24], r = [1, 26], u = [1, 27], t = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(m, [2, 11], {22:9, 19:25, 16:n, 18:q, 20:r, 21:u, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 17]), {13:c, 15:e, 17:28, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:29, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(t, [2, 20]), b(t, [2, 23], {23:[1, 30]}), {13:c, 15:e, 17:31, 19:8, 22:9, 24:g, 25:d, 27:f, 
  ...
  24:g, 25:d, 27:f, 28:h}, {13:c, 14:39, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 14:40, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:41, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:42, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(t, [2, 14]), {13:c, 15:e, 17:43, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:44, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(t, [2, 18]), b(t, [2, 19]), {13:c, 15:e, 17:45, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(t, [2, 22]), {13:k, 
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(m, [2, 9], {22:9, 19:25, 16:n, 18:q, 20:r, 21:u, 24:g, 25:d, 27:f, 28:h}), b(m, [2, 10], {22:9, 19:25, 16:n, 18:q, 20:r, 21:u, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 12]), b(t, [2, 13]), b(t, [2, 15]), b(t, [2, 16]), b(t, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], f = this.table, e = "", g = 0, h = 0, k = 0, m = d.slice.call(arguments, 1), l = Object.create(this.lexer), n = {}, q;
    for (q in this.yy) {
      Object.prototype.hasOwnProperty.call(this.yy, q) && (n[q] = this.yy[q]);
    }
    l.setInput(a, n);
    n.lexer = l;
    n.parser = this;
    ...
    q = l.yylloc;
    d.push(q);
    var u = l.options && l.options.ranges;
    this.parseError = "function" === typeof n.parseError ? n.parseError : Object.getPrototypeOf(this).parseError;
    for (var r, t, w, I, M = {}, N, K;;) {
      w = b[b.length - 1];
      if (this.defaultActions[w]) {
        I = this.defaultActions[w];
      } else {
        if (null === r || "undefined" == typeof r) {
          r = void 0, r = l.lex() || 1, "number" !== typeof r && (r = this.symbols_[r] || r);
        }
        I = f[w] && f[w][r];
      }
      if ("undefined" === typeof I || !I.length || !I[0]) {
        var O = "";
        K = [];
        for (N in f[w]) {
          this.terminals_[N] && 2 < N && K.push("'" + this.terminals_[N] + "'");
        }
        O = l.showPosition ? "Parse error on line " + (g + 1) + ":\n" + l.showPosition() + "\nExpecting " + K.join(", ") + ", got '" + (this.terminals_[r] || r) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == r ? "end of input" : "'" + (this.terminals_[r] || r) + "'");
        this.parseError(O, {text:l.match, token:this.terminals_[r] || r, line:l.yylineno, loc:q, expected:K});
      }
      if (I[0] instanceof Array && 1 < I.length) {
        throw Error("Parse Error: multiple actions possible at state: " + w + ", token: " + r);
      }
      switch(I[0]) {
        case 1:
          b.push(r);
          ...
          b.push(I[1]);
          r = null;
          t ? (r = t, t = null) : (h = l.yyleng, e = l.yytext, g = l.yylineno, q = l.yylloc, 0 < k && k--);
          break;
        case 2:
          K = this.productions_[I[1]][1];
          M.$ = c[c.length - K];
          M._$ = {first_line:d[d.length - (K || 1)].first_line, last_line:d[d.length - 1].last_line, first_column:d[d.length - (K || 1)].first_column, last_column:d[d.length - 1].last_column};
          u && (M._$.range = [d[d.length - (K || 1)].range[0], d[d.length - 1].range[1]]);
          w = this.performAction.apply(M, [e, h, g, n, I[1], c, d].concat(m));
          if ("undefined" !== typeof w) {
            return w;
          }
          K && (b = b.slice(0, -2 * K), c = c.slice(0, -1 * K), d = d.slice(0, -1 * K));
          b.push(this.productions_[I[1]][0]);
          c.push(M.$);
          d.push(M._$);
          I = f[b[b.length - 2]][b[b.length - 1]];
          b.push(I);
          break;
        case 3:
          return !0;
    ...
    return {EOF:1, parseError:function(a, b) {
      ...
      for (var d = this._currentRules(), f = 0;f < d.length;f++) {
        if ((b = this._input.match(this.rules[d[f]])) && (!a || b[0].length > a[0].length)) {
          if (a = b, c = f, this.options.backtrack_lexer) {
            a = this.test_match(b, d[f]);
            if (!1 !== a) {
              return a;
            }
            if (this._backtrack) {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, k, l) {
      ...
      try {
        ...
        w = null != (t = a.match(b)) ? t : [];
        n = 0;
        for (r = w.length;n < r;n++) {
          q = w[n], 0 > g.call(c, q) && CTATFormulaFunctions.assign(q, void 0);
        }
        for (q in x = this.variableTable.getTable()) {
          u[q] = x[q];
        }
        ...
        }).apply(u, [d, k, l].concat(e.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (q in u) {
          null != q && 0 > g.call(m, q) && (x[q] = u[q], delete u[q]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      var e, g, q, r, u;
      r = a.split(this.interpolateSplitPattern);
      u = [];
      a = g = 0;
      for (q = r.length;g < q;a = ++g) {
        e = r[a], u.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return u.join("");
    };
    return a;
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, f = "undefined" === typeof c || null === c ? null : c, h = null, k = 1, l = 1, m = "CORRECT_ACTION", n = [], q = !1, r = null, u = "", t = null, w = null, x = this;
  ...
  this.setIsPreferredLink = function(a) {
    x.ctatdebug("ETLink.setIsPreferredLink() was " + q + ", now " + a);
    q = a;
  };
  this.setVisualData = function(a) {
    t = a;
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var e = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, f = !1, h = null, k = null, l = "student", m = null, n = null, q = "", r = null, u = null, t = null, w = null, x = null, B = [], D = !1, p = null, y = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e setActor(" + a + ")");
    l = a;
  };
  this.getStudentSAI = function() {
    y.ctatdebug("CTATExampleTracerEvent.getStudentSAI() returning type " + typeof h + ", value " + h);
    return h;
  };
  this.setStudentSAI = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setStudentSAI(" + a + ")");
    null !== a && "undefined" !== typeof a && (h = a);
    y.ctatdebug("CTATExampleTracerEvent --\x3e out of setStudentSAI");
  };
  this.getPreloadedLinkMatches = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getPreloadedLinkMatches");
    return u;
  };
  this.setTutorSAI = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setTutorSAI");
    null !== a && "undefined" !== typeof a && (k = a);
    y.ctatdebug("CTATExampleTracerEvent --\x3e out of setTutorSAI");
  };
  this.setNumberOfInterpretations = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setNumberOfInterpretations( " + a + " )");
  };
  this.getTransactionID = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + e);
    return e;
  };
  this.setTransactionID = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setTransactionID( " + a + " )");
    e = a;
  };
  this.setDoneStepFailed = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setDoneStepFailed( " + a + " )");
    g = a;
  };
  ...
  this.setResult = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( " + a + " )");
    d = a;
  };
  this.isSolverResult = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");
    return !1;
  };
  this.getResult = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + d);
    return d;
  };
  this.setReportableLink = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink(" + a + ")");
    m = a;
  };
  this.setReportableInterpretation = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation(" + a + ")");
    n = a;
  };
  this.setStepID = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID(" + a + ")");
    q = a;
  };
  ...
  this.setSuccessOrBuggyMsg = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg(" + a + ")");
    x = a;
  };
  this.setReportableHints = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints(" + a + ")");
    B = Array.isArray(a) && 0 < a.length ? a : [];
  };
  this.getWantReportableHints = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + D);
    return D;
  };
  this.setOutOfOrder = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder(" + a + ")");
    r = a;
  };
  this.isOutOfOrder = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + r);
    return r;
  };
  this.setEvaluatedInput = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput(" + a + ")");
  ...
  this.addPreloadedLinkMatch = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch(" + a + ")");
    if (null === u || "undefined" === typeof u) {
      u = [];
    }
    u.push(a);
  };
  this.setInterpolateSAI = function(a, b, c) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolateSAI(selection " + a + " action " + b + " input " + c + ")");
  };
  this.setInterpolatedHints = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints(" + a + ")");
    null !== p && "undefined" !== typeof p && (p.length = 0);
    null !== a && "undefined" !== typeof a && (p = a.slice(0));
    y.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints");
  };
  this.setWantReportableHints = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints(" + a + ")");
    D = a;
  };
  this.getSuccessOrBuggyMsg = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + x);
    return x;
  };
  this.getReportableHints = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + B);
    return B;
  };
  this.getReportableLink = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + m);
    return m;
  };
  this.getReportableVariableTable = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + w);
    return w;
  };
  this.getReportableInterpretation = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + n);
    return n;
  };
  this.getStepID = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + q);
    return q;
  };
  ...
  this.getTutorInput = function() {
    return null !== t && "undefined" !== typeof t ? y.getEvaluatedInputArray() : null !== k && "undefined" !== typeof k ? k.getInputArray() : null;
  };
  ...
  this.toString = function() {
    var a;
    a = "[" + y.getResult();
    null !== y.getStudentSAI() && "undefined" !== typeof y.getStudentSAI() && (a += ", StudentSAI " + y.getStudentSAI());
    null !== y.getReportableLink() && "undefined" !== typeof y.getReportableLink() && (a += ", reportableLink " + y.getReportableLink());
    !0 === y.isDoneStepFailed() && (a += ", doneStepFailed");
    null !== y.getTutorSAI() && "undefined" !== typeof y.getTutorSAI() && (a += ", TutorSAI " + y.getTutorSAI());
    return a + "]";
  };
...
var CTATExpressionMatcher = function(a, b) {
  function c(a, b, c, f, g) {
    ...
    var r = CTATVariableTable.standardizeType(c);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof c + "; inputConv " + r + ", typeof " + typeof r);
    c = h.evaluate(a, b, r, g);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + r + ", " + g + ") returned " + c + ", type " + typeof c);
    g = null;
    switch(f) {
...
var CTATVectorMatcher = function(a, b, c, e) {
  function g(a, b, c, e, g) {
    ...
    var t = [];
    t[CTATMatcher.SELECTION] = a;
    t[CTATMatcher.ACTION] = b;
    t[CTATMatcher.INPUT] = c;
    for (var w = 0;3 > w;w++) {
      var x = k[w][0], B = x instanceof CTATExpressionMatcher ? x.matchConcatenation(a, b, c, e) : x.matchConcatenation(t[w]);
      l.ctatdebug("CTATVectorMatcher --\x3e in _match[" + w + "] after " + x + ".concat returns: " + B);
      if (g) {
        g.push(B);
      } else {
        if (!1 === B) {
  ...
  this.getTutorSAI = function(a, b, c) {
    ...
    if (CTATExampleTracerLink.CORRECT_ACTION.toLowerCase() == c) {
      return a;
    }
    var d = [];
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  this.updateVariableTable = function(a, b, c) {
    ...
    if (CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase()) {
      a = a.getSelection(), null !== a && "undefined" !== typeof a && 0 < a.length && e.put(a, d);
    }
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  function c(a, b, c) {
    ...
    b = new CTATFormulaParser(b);
    p.ctatdebug("CTATETT.interpolate(" + a + ",vt," + c + ")");
    var d = c.getSelection(), e = c.getAction();
    c = c.getInput();
    c = CTATVariableTable.standardizeType(c);
    p.ctatdebug("CTATETT.interpolate() calling CTATFP.interpolate(" + a + ", " + d + ", " + e + ", " + c);
    a = b.interpolate(a, d, e, c);
    p.ctatdebug("CTATETT.interpolate() returning " + a);
    return a;
  }
  function e(a, b, e) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate(" + a + ", " + b + ", " + e + ")");
    B = a;
    var l = new Set, m = a.getPreloadedLinkMatches();
    p.ctatdebug("interps # : " + u.length);
    p.ctatdebug("interps: " + u);
    u.forEach(function(c) {
      p.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof m || null === m) {
        p.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), m = g(a.getStudentSAI(), a.getActor(), b, c.getVariableTable(), a), p.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      }
      p.ctatdebug("Link matches # : " + m.length);
      m.forEach(function(b) {
        p.ctatdebug("In evaluate -- entered the saiLinkMatches loop + " + b);
        if (c.getTraversalCount(b) >= b.getMaxTraversals()) {
          return p.ctatdebug("In evaluate -- skipped a saiLinkMatches loop \n Skipped due to max traversals" + b.getMaxTraversals()), !1;
        }
        var g = c.clone();
        p.ctatdebug("In evaluate size of getPaths " + g.getPaths().size);
        g.getPaths().forEach(function(c) {
          p.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: " + c);
          !1 === d(b, g, c, !1, a) && (p.ctatdebug("In evaluate -- in if condition, checking if isPathOK"), g.getPaths().delete(c), p.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."));
        });
        p.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size " + g.getPaths().size);
        if (0 < g.getPaths().size) {
          p.ctatdebug("In evaluate -- if number of paths is greater than 0");
          g.addLink(b);
          p.ctatdebug("In evaluate -- new link added");
          if (!0 === e) {
            p.ctatdebug("In evaluate -- we are in the doUpdate if condition");
            var h = f(b, a.getStudentSAI(), g);
            p.ctatdebug("In evaluate -- updatingVariable table");
            g.updateVariableTable(a.getStudentSAI(), h, b);
            p.ctatdebug("In evaluate -- done updatingVariable table: " + g.getVariableTable());
          }
          l.add(g);
          p.ctatdebug("In evaluate -- added new interp");
        }
        p.ctatdebug("In evaluate -- out of saiLinkMatches loop");
      });
      p.ctatdebug("In evaluate -- out of interpretation loops");
    });
    a.setNumberOfInterpretations(l.size);
    p.ctatdebug("In evaluate -- number of interpretations " + l.size + " set");
    if (0 === l.size) {
      return p.ctatdebug("In evaluate -- if condition no new interpretations"), 0 !== m.length && !0 === m[0].isDone() && a.setDoneStepFailed(!0), a.setResult(CTATExampleTracerLink.NO_MODEL), p.ctatdebug("In evaluate -- if condition no new interpretations returning false"), !1;
    }
    var n = h(l);
    p.ctatdebug("In evaluate -- just found bestInterp");
    var q = null;
    !0 === a.isSolverResult() ? (p.ctatdebug("In evaluate -- in if branch of isSolverResult"), q = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (p.ctatdebug("In evaluate -- in else branch of isSolverResult"), q = n.getLastMatchedLink().getType());
    if (!0 === e) {
      p.ctatdebug("In evaluate -- in if Branch doUpdate()");
      w.push(a.getStudentSAI());
      if (q.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || q.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        p.ctatdebug("In evaluate -- in first branch doUpdate()");
        l.forEach(function(a) {
          a.getLastMatchedLink().getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && (p.ctatdebug("In evaluate -- deleting an incorrect interp"), l.delete(a));
        });
        p.ctatdebug("In evaluate -- after iterating over interpretations");
        k(l);
        p.ctatdebug("In evaluate -- after setting new interps");
        for (var r in t) {
          t.hasOwnProperty(r) && delete t[r];
        }
        p.ctatdebug("In evaluate -- out of DoUpdate if branch");
      } else {
        p.ctatdebug("In evaluate -- in else branch of doUpdate");
        a.setNumberOfInterpretations(0);
        for (var x in t) {
          t.hasOwnProperty(x) && delete t[x];
        }
        l.forEach(function(a) {
          t[a.getLastMatchedLink().getUniqueID()] = a.getLastMatchedLink();
        });
      }
      q.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && w.splice(w.length - 1, 1);
    }
    r = n.getLastMatchedLink();
    a.isSolverResult() || (p.ctatdebug("In evaluate inside the solver result if condition + " + q), a.setResult(q));
    p.ctatdebug("In evaluate out the solver result if condition");
    a.setReportableLink(r);
    a.setReportableInterpretation(n);
    a.setReportableVariableTable(n.getVariableTable());
    a.setHintRequest(b);
    b || (x = r.getTutorSAI(a.getStudentSAI(), n.getVariableTable()), p.ctatdebug("In evaluate -- TUTORSAI object: " + x + ", getInput() " + x.getInput() + ";"), a.setTutorSAI(x));
    x = q == CTATExampleTracerLink.CORRECT_ACTION ? r.getSuccessMsg() : r.getBuggyMsg();
    a.setSuccessOrBuggyMsg(c(x, n.getVariableTable(), a.getStudentSAI()));
    x = a.getStudentSAI();
    a.setInterpolateSAI(x.getSelection(), x.getAction(), x.getInput());
    p.ctatdebug("In evaluate after calling setInterpolatesSAI");
    b && (n = r.interpolateHints(n.getVariableTable()), a.setInterpolatedHints(n), p.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(n) && 0 < n.length ? a.setReportableHints(n) : a.setReportableHints(r.getHints()), p.ctatdebug("In evaluate --\x3e after setReportableHints"));
    p.ctatdebug("In evaluate after fireExampleTracerEvent");
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of _evaluate");
    return q.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString();
  }
  function g(a, b, c, d, e) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks(" + a + ", " + b + ", " + c + ")");
    var f = [];
    x.getLinks().forEach(function(g) {
      if (!1 === c) {
        p.ctatdebug("Calling link.matchesSAI() on link " + g + ", sai " + a);
        var h = g.matchesSAI(a, b, d);
        p.ctatdebug("Result from link.matchesSAI() on link " + g + ": " + h + ", typeof " + typeof h);
        !0 === h && f.push(g);
      } else {
        !0 === g.matchesSAIforHint(a, b, e, d) && f.push(g);
      }
    });
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks " + f.length);
    return f;
  }
  function d(a, b, c, d, e) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK");
    var f = null;
    if (!0 === d) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK in demonstrate mode");
      var g = b.getMatchedLinks().slice();
      g.push(a);
      f = c.getLinksRestricted(g);
    } else {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK NOT in demonstrate mode"), f = c.getLinks();
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK path.getLinks() " + c.getLinks().size);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK pathLinks " + f.size);
    if (!0 === d) {
      var h = [], k = !0;
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === x.observesOrderingConstraints(h, a, f, e) || !1 === m(b, a, f) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
        return p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false2"), !1;
      }
    }
    if (a.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      if (!1 === x.isIncorrectLinkOK(b.getMatchedLinks(), a, f, b)) {
        return p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"), !1;
      }
    } else {
      if (!1 === x.observesOrderingConstraints(b.getMatchedLinks(), a, f, e)) {
        return p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false4"), !1;
      }
      if (!1 === m(b, a, f)) {
        return p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false5"), !1;
      }
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of isPathOK returning true");
    return !0;
  }
  function f(a, b, c) {
    p.ctatdebug("CTATExampleTracerTracer.replaceInput(" + a + ", " + b + ", ...)");
    if (null === a || "undefined" === typeof a || !1 === a.replaceInput()) {
      return p.ctatdebug("replaceInput false, returning null"), null;
    }
    a = a.evaluateReplacement(b, c.getVariableTable(), p);
    p.ctatdebug("CTATExampleTracerTracer.replaceInput() returning " + a);
    return a;
  }
  function h(a) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation");
    var b = new CTATExampleTracerInterpretationComparator, c = null;
    a.forEach(function(a) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation iteration");
      null === c || "undefined" === typeof c ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation first if condition"), c = a) : (p.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation else of first if condition"), 0 < b.compare(a, c) && (p.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation second if condition"), c = a));
    });
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of findBestInterpretation");
    return c;
  }
  function k(a) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in setInterpretations");
    u.length = 0;
    0 === a.size ? p.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (p.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      u.push(a);
    }), D = null, p.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function l() {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");
    var a = x.findAllPaths();
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths: #paths " + a.size);
    a.forEach(function(a) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths loopring through paths");
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths size of path" + a.getLinks().size);
    });
    return a;
  }
  function m(a, b, c) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in doneStepOK: link " + b + ", isDone() " + b.isDone());
    if (null === b || "undefined" === typeof b || !1 === b.isDone()) {
      return p.ctatdebug("doneStepOK in first if condition"), !0;
    }
    if (b.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      return p.ctatdebug("doneStepOK in second if condition"), !0;
    }
    p.ctatdebug("doneStepOK before loop");
    var d = !0;
    c.forEach(function(c) {
      !1 === d ? p.ctatdebug("CTATExampleTracerTracer --\x3e we are breaking from the loop") : c.getUniqueID() === b.getUniqueID() ? p.ctatdebug("CTATExampleTracerTracer --\x3e inside second if condition") : a.getTraversalCount(c) < c.getMinTraversals() && (p.ctatdebug("CTATExampleTracerTracer --\x3e we should return false from the second if condition"), d = !1);
    });
    if (!1 === d) {
      return p.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning false"), !1;
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning true");
    return !0;
  }
  function n(a, b) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink");
    var c = null !== b && "undefined" !== typeof b && null !== b[0] && "undefined" !== typeof b[0] ? b[0] : null;
    if (null === c || "undefined" === typeof c) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink first if condition"), c = p.getBestInterpretation();
    }
    null !== b && "undefined" !== typeof b && (b[0] = c);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink interp.getPaths(): " + c.getPaths().size);
    var d = CTATExampleTracerPath.getBestPath(c.getPaths());
    p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink path: " + d);
    var e = q(c, d, a, !1);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink highestLink: " + e);
    if (null !== e && "undefined" !== typeof e) {
      return p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink returning highestLink"), e;
    }
    var f = null;
    p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink returning path.getLinks() " + d.getLinks().size);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink returning path.getSortedLinks() " + d.getSortedLinks());
    var g = !1, h = null;
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < p.nonEmptyHints(b, c.getVariableTable())) && x.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && m(c, b, d.getLinks()) && (p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of _getBestNextLink, returning: " + f);
    return null;
  }
  function q(a, b, c, e) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink");
    var f = new CTATExampleTracerEvent(p, null, CTATMsgType.DEFAULT_STUDENT_ACTOR), g = !0, h = [];
    b.getSortedLinks().forEach(function(b) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop link.getUniqueID(): " + b.getUniqueID());
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop interp.isTraversed(link, countOptionalAsTraversed): " + a.isTraversed(b, e));
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop isNoOp(link): " + r(b));
      !0 === a.isTraversed(b, e) || !0 === r(b) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), g = !0) : (!0 === g && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), x.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
        c && 1 > p.nonEmptyHints(b, a.getVariableTable()) || a.getTraversalCount(b) >= b.getMaxTraversals() || (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink pushing outlink: " + b.getUniqueID()), h.push(b));
      })), g = null === b || "undefined" === typeof b ? !1 : b.getMinTraversals() <= a.getTraversalCount(b));
    });
    h.sort(function(b, c) {
      return (new CTATExampleTracerLinkComparator(a, p)).compare(b, c);
    });
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink before sorting");
    var k = !1, l = null;
    h.forEach(function(c) {
      !0 !== k && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in fro loop"), !0 === d(c, a, b, !1, f) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting first if"), l = c, k = !0) : a.getPaths().forEach(function(e) {
        !0 !== k && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in inner loop"), b !== e && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting second if"), !0 === d(c, a, e, !1, f) && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting third if"), l = c, k = !0)));
      }));
    });
    if (!0 === k) {
      return p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink returning: " + l.getUniqueID()), l;
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of getHighestUntraversedLink");
    return null;
  }
  function r(a) {
  ...
  var u = null, t = null, w = null, x = a, B = null;
  CTATExampleTracerTracer_count++;
  var D = null, p = this;
  this.getLastResult = function() {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");
    return B;
  };
  this.resetTracer = function() {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");
    null === u || "undefined" === typeof u ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), u = []) : (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), u.length = 0);
    var a = new CTATExampleTracerInterpretation(l());
    p.ctatdebug("CTATExampleTracerTracer tempInterp--\x3e in resetTracer tempInterp " + a);
    null !== b && "undefined" !== typeof b && (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer startStateVT if condition"), a.setVariableTable(b));
    u.push(a);
    D = a;
    if (null === t || "undefined" === typeof t) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), t = {};
    } else {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");
      for (var c in t) {
        t.hasOwnProperty(c) && delete t[c];
      }
    }
    null === w || "undefined" === typeof w ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), w = []) : (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), w.length = 0);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");
    x.getLinks().forEach(function(a) {
      a.getMatcher().resetMatcher();
    });
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of resetTracer");
  };
  this.evaluate = function(a) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in public evaluate(), calling private _evaluate; given event " + a);
    return e(a, !1, !0);
  };
  this.nonEmptyHints = function(a, b) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints");
    if (null === a || "undefined" === typeof a) {
      return 0;
    }
    var c = a.interpolateHints(b);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints: link.interpolateHints() " + a.interpolateHints().length);
    ...
    p.ctatdebug("CTATExampleTracerTracer --\x3e returning from nonEmptyHints " + d);
    return d;
  };
  this.traceForHint = function(a) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint");
    var b = e(a, !0, !1);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint return from evaluate " + b);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint result from evaluate " + a.getResult().toString());
    p.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint link   from evaluate " + a.getReportableLink());
    if (a.getResult().toString() === CTATExampleTracerLink.CORRECT_ACTION.toString()) {
      return b = a.getReportableLink(), a.setTutorSAI(new CTATSAI(a.getStudentSAI().getSelection(), b.getDefaultSAI().getAction(), b.getDefaultSAI().getInput())), a.setActor(CTATMsgType.DEFAULT_STUDENT_ACTOR), p.ctatdebug("CTATExampleTracerTracer --\x3e traceForHint returning hintLink " + b + ", result " + a), b;
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of traceForHint, returning null");
    return null;
  };
  this.matchForHint = function(a) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in matchForHint");
    var b = null, b = null === a.getStudentSAI() || "undefined" === typeof a.getStudentSAI() ? null : a.getStudentSAI().getSelectionArray();
    if (null !== b && "undefined" !== typeof b && 0 < b.length && (p.ctatdebug("CTATExampleTracerTracer --\x3e in matchForHint first if"), a.setWantReportableHints(!0), b = p.traceForHint(a), null !== b && "undefined" !== typeof b && 0 < a.getReportableHints().length)) {
      return p.ctatdebug("CTATExampleTracerTracer --\x3e matchForHint via traceForHint returning " + b + ", result " + a), b;
    }
    b = p.getBestNextLink(!0, a);
    p.ctatdebug("CTATExampleTracerTracer --\x3e matchForHint() traceForHint via getBestNextLink returning " + b);
    return b;
  };
  this.getBestNextLink = function(a, b) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink");
    var c = [], d = n(a, c);
    if (null === d || "undefined" === typeof d) {
      return p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink returning null"), null;
    }
    if (d.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      return p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink return null no correct suboptimal step"), null;
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink else branch");
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink got interp " + (null == c ? "null" : c[0]));
    if (b) {
      var e = d.interpolateHints(c[0].getVariableTable());
      b.setInterpolatedHints(e);
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink setInterpolatedHints");
      Array.isArray(e) && 0 < e.length ? b.setReportableHints(e) : b.setReportableHints(d.getHints());
      p.ctatdebug("In evaluate --\x3e after setReportableHints");
      b.setReportableLink(d);
      b.setReportableInterpretation(c[0]);
      b.setResult(d.getType());
      b.setTutorSAI(d.getDefaultSAI());
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink return etLink");
    return d;
  };
  this.doHint = function(a, b, c, d, e, f) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint");
    var g = c = c = null;
    if (f && null !== b && "undefined" !== typeof b && 1 < b.length && b[1].toString() === CTATMsgType.PREVIOUS_FOCUS.toString() && null !== a && "undefined" !== typeof a && 1 < a.length && null !== a[1] && "undefined" !== typeof a[1] && a[1].toString() !== "null".toString() && (p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint first if condition"), c = [], c.push(a[1]), 2 < b.length)) {
      for (p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint inner if condition"), g = [], a = 2;a < b.length;a++) {
        p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint for loop " + a), g.push(b[a]);
      }
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint out of if condition");
    b = new CTATExampleTracerEvent(p, new CTATSAI(c, g, null), d);
    p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint result: " + b);
    c = p.matchForHint(b);
    b.setHintRequest(!0);
    Array.isArray(e) && (p.ctatdebug("CTATExampleTracerTracer --\x3e in doHint last if condition"), e.push(b));
    p.ctatdebug("CTATExampleTracerTracer --\x3e returning from doHint: " + c);
    return c;
  };
  this.getBestInterpretation = function() {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation");
    if (null === D || "undefined" === typeof D) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), D = h(p.getInterpretationsInternal());
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === D || void 0 === D));
    return D;
  };
  this.getInterpretationsInternal = function() {
    p.ctatdebug("CTATExampleTracerTracer --\x3e in getInterpretationsInternal");
    return u;
  };
  this.toString = function() {
    var a = "TracerState\n";
    null === u ? a += "(no interpretations)\n" : u.forEach(function(b) {
      a += b.toString() + "\n";
    });
    return a;
  };
  this.addInterfaceVariablesFromEvent = function(a) {
    if (a) {
      ...
      a = a.getTutorInput();
      p.addInterfaceVariables(b, a);
    }
  };
  this.addInterfaceVariables = function(a, c) {
    p.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables(" + a + ", " + c + ")");
    if (a && c) {
      var d = a.length;
      ...
      p.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() startStateVT " + b);
      u && u.forEach(function(b) {
        if (b = b.getVariableTable()) {
          for (var e = 0;e < d;e++) {
            a[e] && b.put(a[e], CTATVariableTable.standardizeType(c[e]));
          }
          p.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() interp.vt " + b);
        }
      });
    }
  };
  this.findCurrentState = function() {
    p.ctatdebug("Entering findCurrentState");
    var a = p.getBestInterpretation();
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = n(!1, [a])) ? a.getPrevNode() : x ? x.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, c) {
  ...
  function g(a, b, c) {
    ...
    for (var e = !0, f = 0;f < b.length;f++) {
      if (!0 === e && !1 === A.isGroupReenterable(b[f])) {
        for (var e = !1, g = 0;g < a.length;g++) {
          if (!0 === A.isLinkInGroup(b[f], a[g])) {
            e = !0;
          } else {
            if (!0 === e) {
              return !1;
    ...
    if (0 !== a.length) {
      ...
      h.forEach(function(a) {
        !0 === A.isGroupReenterable(a) && h.splice(h.indexOf(a), 1);
      });
      var l = !0;
      h.forEach(function(b) {
        !1 !== l && c.forEach(function(c) {
          !1 !== l && k(a, c) < c.getMinTraversals() && !0 === A.isLinkInGroup(b, c) && (l = !1);
        });
      });
      if (!1 === l) {
        return !1;
  ...
  function d(a) {
    z.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof A);
    a = A.getGroupsContainingLink(a);
    ...
    b.sort(function(a, b) {
      return A.getGroupLinkCount(b) - A.getGroupLinkCount(a);
    });
    return b;
  }
  function f(a, b, c, d) {
    var e = -1, f = null, g = Number.MAX_VALUE, l = null;
    A.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === A.isLinkInGroup(a, b) && 0 !== A.getGroupLinkCount(a)) {
        var k = h(a, d);
        null !== k && "undefined" !== typeof k && (k = k.getDepth(), k < b.getDepth() && k > e && (!1 === m(a) || !0 === n(a, c)) && (e = k, f = a), k > b.getDepth() && k < g && (!1 === m(a) || !0 === n(a, c)) && (g = k, l = a));
      }
    });
    A.getUniqueLinks(a).forEach(function(a) {
      if (!0 === d.has(a)) {
        var h = a.getDepth();
    ...
    if (null !== f && "undefined" !== typeof f) {
      if (f instanceof CTATExampleTracerLink) {
        ...
        if (f instanceof CTATLinkGroup && !1 === q(f, c, d)) {
          return !1;
        }
      }
    }
  ...
  function h(a, b) {
    ...
    A.getGroupLinks(a).forEach(function(a) {
  ...
  function l(a, b, c) {
    ...
    (new CTATExampleTracerPath(b)).getSortedLinks().forEach(function(b) {
      if (!1 !== e && !0 !== f) {
        if (!1 === d) {
          !0 === A.isLinkInGroup(a, b) && (d = !0);
        } else {
          if (!1 === A.isLinkInGroup(a, b)) {
            f = !0;
            return;
          }
        }
  ...
  var w = null, x = null, B = null, D = null, p = null, y = null, v = new Set, C = null, A = null, z = this;
  this.getDefaultBuggyMsg = function() {
    return A.getTopLevelGroup() ? A.getTopLevelGroup().getDefaultBuggyMsg() : null;
  };
  this.getLinks = function() {
  ...
  this.addLink = function(a, b) {
    ...
    B.push(a);
    null === b || "undefined" === typeof b ? A.addLinkToGroup(A.getTopLevelGroup(), a) : A.addLinkToGroup(b, a);
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === f && (b = z.getSmallestContainingGroup(b), !0 === A.isLinkInGroup(b, g) && !1 === A.isGroupOrdered(b) && !0 === l(b, c, d))) {
      return !1;
    }
  ...
  this.getStartNode = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + p);
    return p;
  };
  this.getLinkByID = function(a) {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getLinkByID");
    for (var b = 0;b < B.length;b++) {
      if (B[b].getUniqueID() === a) {
        return B[b];
      }
    }
  ...
  this.getStudentStartsHereNode = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + y);
    return y;
  };
  ...
  this.getSmallestContainingGroup = function(a) {
    return A.getLowestLevelGroupOfLink(a);
  };
  ...
  this.getVisualData = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + C);
    return C;
  };
  (function(a, b) {
    ...
    D = {};
    if (null === A || "undefined" === typeof A) {
      A = new CTATDefaultGroupModel, z.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    A.clear();
    A.setDefaultReenterable(!b);
    A.setGroupOrdered(A.getTopLevelGroup(), a);
    A.setGroupName(A.getTopLevelGroup(), CTATExampleTracerGraph.TOP_LEVEL);
...
var CTATMessageTank = function(a, b) {
  function c(a) {
    n.ctatdebug("entering updateProblemSummary()");
    a && f.forEach(function(b) {
      if (b.msgType == CTATMsgType.ASSOCIATED_RULES) {
        var c = b.evt;
        n.ctatdebug("entering updateProblemSummaryWithEvent(" + c + ")");
        if (c) {
          b = c.getResult();
          c.getHintRequest() && (b = CTATExampleTracerLink.HINT_ACTION);
          var d = CTATMsgType.CompletionValue[0];
          a.setCompletionStatus(d, !0);
          var e = b && b == CTATExampleTracerLink.CORRECT_ACTION, f = !1, h = null, k = c.getStudentSAI();
          k && (h = k.getSelection()) && (f = "done" == String(h).toLowerCase());
          n.ctatdebug("updateProblemSummmary() Completion status " + d + ", doneStep " + f + ", correct " + e);
          f && (d = e ? CTATMsgType.CompletionValue[1] : CTATMsgType.CompletionValue[0], a.setCompletionStatus(d, !0));
          d == CTATMsgType.CompletionValue[1] ? (a.stopTimer(), g && g.setOutputStatus(CTATProblemStateStatus.complete)) : a.restartTimer();
          d = c.getActor();
          n.ctatdebug("updateProblemSummmary() actor " + d + ", indicatorObj " + b);
          CTATMatcher.isTutorActor(d) || (c = c.getStepID(), CTATTutorMessageBuilder.isHint(b) ? a.addHint(c) : CTATTutorMessageBuilder.isCorrect(b) ? null !== b && "undefined" !== typeof b && a.addCorrect(c) : a.addError(c));
        }
      }
    });
  }
  function e(a) {
    switch(n.suppressFeedback(a, g.getFeedbackPolicy())) {
      case CTATMsgType.SHOW_ALL_FEEDBACK:
        return !1;
      case CTATMsgType.DELAY_FEEDBACK:
        a = a.msg;
        var b = CTATMsgType.getProperty(a, "Selection");
        b && (d || (d = {}), d[b.toLowerCase()] = a);
        return !0;
  ...
  var g = a, d = null, f = null, h = null, k = null, l = new Set;
  l.add("SuccessMessage");
  l.add("BuggyMessage");
  l.add("HighlightMsg");
  l.add("NotDoneMessage");
  var m = b, n = this, d = null;
  this.toString = function() {
    n.ctatdebug("toString tank " + f);
    if (!f || 1 > f.length) {
  ...
  this.enqueueToolActionToStudent = function(a, b, c, d) {
    n.ctatdebug("Entering enqueueToolActionToStudent(" + a + ", " + b + ", " + c + ", " + d + ")");
    var e = CTATMsgType.INTERFACE_ACTION;
    n.ctatdebug("entering enqueueMessageToStudent()");
    var f = CTATMessage.makeTransactionId(), h = new CTATSAI(a, b, c), h = (new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage(f, h), h = CTATMsgType.setProperty(h, CTATTutorMessageBuilder.TRIGGER, "DATA"), h = CTATMsgType.setProperty(h, CTATTutorMessageBuilder.SUBTYPE, null === d || "undefined" === typeof d || 1 > d.length ? CTATTutorMessageBuilder.TUTOR_PERFORMED : d);
    a = new CTATExampleTracerEvent(g, new CTATSAI(a, b, c), CTATMsgType.DEFAULT_TOOL_ACTOR);
    a.setTransactionID(f);
    n.addToMessageTank(e, h, a);
    return f;
  };
  this.addToMessageTank = function(a, b, c) {
    n.ctatdebug("Entering addToMessageTank(" + a + ", " + b + ", " + c + ")");
    if (b) {
      f || (f = [], h = {}, k = {});
      var d = {};
      d.msgType = a;
      ...
      k[a] = k[a] ? k[a] + 1 : 1;
      n.ctatdebug("Exiting addToMessageTank() this " + n.toString());
    }
  };
  this.flushMessageTank = function(a, b) {
    n.ctatdebug("Entering flushMessageTank(" + a + ", " + b + ")");
    if (f && !(1 > f.length)) {
      c(a);
      n.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + f.length + ", transaction_id " + m);
      for (var d = [], l = 0;l < f.length;++l) {
        var w = f[l];
        if (w.msg) {
          var x = w.msgType, B = w.evt;
          n.ctatdebug("entering processInterfaceVariables() msgType " + x + ", evt " + B);
          x && (n.ctatdebug("entering processInterfaceVariables() et " + g + ", tracer " + (g ? g.getTracer() : null)), x = x.toLowerCase(), 0 !== x.indexOf("correct") && 0 !== x.indexOf("interfaceaction") || g.getTracer().addInterfaceVariablesFromEvent(B));
          e(w) || d.push(w.msg);
        }
      }
      0 < d.length && (n.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + d.length + " via " + g), g.sendBundle(d) && (k[CTATExampleTracerLink.CORRECT_ACTION] || k[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || h.CorrectAction || h.InterfaceAction || h.UntutoredAction) && g.getOutputStatus().isSendingSavedMsgsForRestore() && (d = flashVars.getRawFlashVars(), d.deliverymode ? "delivery" == d.deliverymode ? g.getProblemStateSaver().saveAsYouGo(a) : n.ctatdebug("We're in reviewer mode in OLI, we shouldn't save as we go") : 
      g.getProblemStateSaver().saveAsYouGo(a)), n.ctatdebug("Exiting flushMessageTank() #CorrectAction " + h.CorrectAction + ", #InterfaceAction " + h.InterfaceAction + ", #UntutoredAction " + h.UntutoredAction));
      h = f = m = null;
    }
  };
  this.flushDelayedFeedback = function() {
    n.ctatdebug("Entering flushDelayedFeedback()");
    if (null !== d && "undefined" !== typeof d) {
      for (var a in d) {
        if (d.hasOwnProperty(a)) {
          var b = d[a];
          n.ctatdebug("entering sendMessage()");
  ...
  this.suppressFeedback = function(a, b) {
    n.ctatdebug("CTATMessageTank.suppressFeedback(" + a.msgType + ", " + b + ")");
    var c = null;
    b == CTATMsgType.SHOW_ALL_FEEDBACK ? (n.ctatdebug("if.1"), c = b) : CTATMsgType.hasTextFeedback(a.msgType) ? (n.ctatdebug("if.2"), b == CTATMsgType.HIDE_ALL_FEEDBACK || b == CTATMsgType.HIDE_BUT_ENFORCE ? (n.ctatdebug("if.2.1"), c = b) : (n.ctatdebug("if.2.2"), (c = CTATMsgType.getProperty(a.msg, CTATMsgType.BUGGY_MSG)) && CTATMsgType.NOT_DONE_MSG.toLowerCase() == c.toLowerCase() ? (n.ctatdebug("if.2.2.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (n.ctatdebug("if.2.2.2"), c = CTATMsgType.HIDE_ALL_FEEDBACK))) : 
    CTATMsgType.isCorrectOrIncorrect(a.msgType) ? (n.ctatdebug("if.3: " + a.msg), CTATMsgType.isDoneMessage(a.msg) ? (n.ctatdebug("if.3.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (n.ctatdebug("if.3.2"), c = b)) : (n.ctatdebug("if.4"), c = CTATMsgType.SHOW_ALL_FEEDBACK);
    n.ctatdebug("CTATMessageTank.suppressFeedback() returning " + c);
    return c;
  };
};
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, n, q = a = -1, v = CTATMsgType.DEFAULT_ACTOR, C = !1, A = 0;A < e.length;A++) {
      "sourceID" === f.getElementName(e[A]) && (a = parseInt(f.getNodeTextValue(e[A])), c.setPrevNode(a));
      "destID" === f.getElementName(e[A]) && (q = parseInt(f.getNodeTextValue(e[A])), c.setNextNode(q));
      if ("rule" === f.getElementName(e[A])) {
        for (var z = f.getElementChildren(e[A]), E = 0;E < z.length;E++) {
          "text" === f.getElementName(z[E]) && c.addSkillName(f.getNodeTextValue(z[E]).toString());
        }
      }
      if ("actionLabel" === f.getElementName(e[A])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[A], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[A], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[A], "maxTraversals")), z = f.getElementChildren(e[A]), E = 0;E < z.length;E++) {
          "uniqueID" === f.getElementName(z[E]) && (n = f.getNodeTextValue(z[E]), c.setUniqueID(parseInt(f.getNodeTextValue(z[E]))));
          "message" === f.getElementName(z[E]) && (l = new CTATMessage(z[E]));
          "actionType" === f.getElementName(z[E]) && c.setActionType(f.getNodeTextValue(z[E]));
          "buggyMessage" === f.getElementName(z[E]) && c.setBuggyMsg(f.getNodeTextValue(z[E]));
          "successMessage" === f.getElementName(z[E]) && c.setSuccessMsg(f.getNodeTextValue(z[E]));
          "hintMessage" === f.getElementName(z[E]) && c.addHint(f.getNodeTextValue(z[E]));
          if ("matchers" === f.getElementName(z[E])) {
            for (var F = f.getElementChildren(z[E]), G = 0;G < F.length;G++) {
              "Selection" === f.getElementName(F[G]) && (g = b(F[G], 0)), "Action" === f.getElementName(F[G]) && (h = b(F[G], 1)), "Input" === f.getElementName(F[G]) && (k = b(F[G], 2)), "Actor" === f.getElementName(F[G]) && (v = f.getNodeTextValue(F[G]), C = (C = f.getElementAttr(F[G], "linkTriggered")) && "false" != C.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === f.getElementName(z[E])) {
            h = z[E];
            g = f.getElementAttr(h, "replacementFormula");
            h = f.getElementChildren(h);
            var G = F = v = k = void 0, J = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var v = new CTATExactMatcher(CTATMatcher.ACTION, null), H = 0;H < h.length;H++) {
              if ("matcherType" === f.getElementName(h[H]) && ("ExactMatcher" === f.getNodeTextValue(h[H]) && (G = CTATExactMatcher), "RegexMatcher" === f.getNodeTextValue(h[H]) && (G = CTATRegexMatcher), "AnyMatcher" === f.getNodeTextValue(h[H]) && (G = CTATAnyMatcher), "RangeMatcher" === f.getNodeTextValue(h[H]) && (G = CTATRangeMatcher), "WildcardMatcher" === f.getNodeTextValue(h[H]) && (G = CTATWildcardMatcher), "ExpressionMatcher" === f.getNodeTextValue(h[H]) && (G = CTATExpressionMatcher)), 
              "matcherParameter" === f.getElementName(h[H])) {
                var L = f.getElementAttr(h[H], "name");
                "selection" == L && k.setParameter(f.getNodeTextValue(h[H]));
                "action" == L && v.setParameter(f.getNodeTextValue(h[H]));
                "input" == L && (F = F ? F : new G(CTATMatcher.INPUT, null), F.setParameter(f.getNodeTextValue(h[H])));
                "actor" == L && (J = f.getNodeTextValue(h[H]));
                "minimum" == L && (F = F ? F : new G(CTATMatcher.INPUT, null), F.setParameter(f.getNodeTextValue(h[H]), "minimum"));
                "maximum" == L && (F = F ? F : new G(CTATMatcher.INPUT, null), F.setParameter(f.getNodeTextValue(h[H]), "maximum"));
              }
            }
            F.setReplacementFormula(g);
            v = [[k], [v], [F], J];
            g = v[0];
            h = v[1];
            k = v[2];
    ...
    d.getStartNode() && q == d.getStartNode().getNodeID() && console.log("***WARNING*** edge " + n + " destination is graph startNode " + d.getStartNode());
    n = new CTATVectorMatcher(g, h, k, v);
    n.setDefaultSAI(l.getSAI());
    n.setCaseInsensitive(m);
    n.setLinkTriggered(C);
    c.setMatcher(n);
    ctatdebug("GraphParser.processEdge() " + a + "->" + q + ", edge " + c);
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      ...
      if ("link" === f.getElementName(k[m])) {
        var n = Number(f.getElementAttr(k[m], "id")), q = b[n];
        if (null !== q || void 0 !== q) {
          ctatdebug("Added link ID : " + n), d.add(q);
        }
      }
  ...
  new XMLSerializer;
  var l, m = !0, n = CTATMsgType.SHOW_ALL_FEEDBACK, q = !0;
  ...
  this.parseGraph = function(b, e) {
    ctatdebug("parseBRD()");
    var t = 0, w = f.getElementAttr(b, "startStateNodeName"), x = "true" === f.getElementAttr(b, "unordered");
    m = "false" != String(f.getElementAttr(b, "caseInsensitive")).toLowerCase();
    q = f.getElementAttr(b, "lockWidget");
    var B = new CTATVariableTable;
    d = new CTATExampleTracerGraph(x, !1, B);
    var D = f.getElementChildren(b);
    n = f.getElementAttr(b, "suppressStudentFeedback");
    if (null === n || void 0 === n) {
      n = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    e.setFeedbackPolicy(n);
    var p = f.getElementAttr(b, "highlightRightSelection");
    e.setHighlightRightSelection("false" != p);
    ...
    for (var B = null, v = 0;v < D.length;v++) {
      switch(f.getElementName(D[v])) {
        case "startNodeMessages":
          k = f.getElementChildren(D[v]);
          var C = new CTATTutorMessageBuilder;
          "true" !== y && "false" !== y && n === CTATMsgType.HIDE_ALL_FEEDBACK && (y = "true");
          h = C.createStateGraphMessage(m, x, q, n === CTATMsgType.HIDE_ALL_FEEDBACK, p, confirmDone, e.getSkillBarVector());
          break;
        case "node":
          t++;
          C = D[v];
          ctatdebug("processNode(" + C + ")");
          for (var A = f.getElementChildren(C), z = -1, C = "", E = 0;E < A.length;E++) {
            switch(f.getElementName(A[E])) {
              case "uniqueID":
                z = parseInt(f.getNodeTextValue(A[E]));
                break;
              case "text":
                C = f.getNodeTextValue(A[E]);
            }
          }
          A = new CTATExampleTracerNode(z, new Set);
          "" !== C && A.setNodeName(C);
          C = A;
          d.addNode(C);
          1 == t && (d.setStartNode(C), d.setStudentStartsHereNode(C));
          C.getNodeName() == w && d.setStudentStartsHereNode(C);
          break;
        case "edge":
          d.addLink(a(D[v]));
          break;
    ...
    if (B) {
      t = f.getElementAttr(B, "ordered");
      if (null === t || "undefined" == typeof isordered) {
        t = !x;
      }
      ctatdebug("parseGraph() value of isOrdered = " + t);
      ctatdebug("parseGraph() value of isUnordered = " + x);
      ctatdebug("parseGraph() typeof isOrdered: " + typeof t);
      ctatdebug("parseGraph()typeof isUnordered: " + typeof x);
      w = B;
      ctatdebug("processGroup()");
      l = d.getGroupModel();
      x = l.createIdToLinkMap();
      l.setGroupOrdered(l.getTopLevelGroup(), t);
      ...
      ctatdebug("processGroup() order of group: isOrdered= " + t);
      ctatdebug("processGroup() order of group: isOrdered typeof= " + typeof t);
      t = f.getElementChildren(w);
      for (w = 0;w < t.length;w++) {
        switch(f.getElementName(t[w])) {
          case "group":
            c(t[w], x);
            break;
          case "outOfOrderMessage":
            l.getTopLevelGroup().setDefaultBuggyMsg(f.getNodeTextValue(t[w]));
        }
      }
    }
    d.redoLinkDepths();
...
var CTATExampleTracer = function() {
  function a() {
    m.ctatdebug("workTheQueue() working " + G + ", workQueue.length " + F.length + ", restoreQueue.length " + E.length);
    if (0 == G) {
      for (;0 != (G = 0 < F.length | (0 < E.length) << 1);) {
        var a = null, c = !1;
  ...
  function b(a, b) {
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && m.sendBundle([a]), e(a, f, t, d), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && m.sendBundle([a]), g(a, f, t, d), !0;
      case CTATMsgType.PROBLEM_SUMMARY_REQUEST:
        return setTimeout(function(a) {
          ...
          d.push(c);
          m.sendBundle(d);
          z.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE, a.getCompletionStatus());
          m.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '" + c + "';");
          m.setWorking(b ? 1 : 0, !1);
        }, 4E3), !1;
      case CTATMsgType.START_STATE_END:
        return z.transition(CTATMsgType.START_STATE_END), !0;
      case CTATMsgType.PROBLEM_RESTORE_END:
        return l(), !0;
      default:
  ...
  function c(a, b, c, d) {
    ...
    J = !1;
    v = b.getProperty("problem_name");
    m.ctatdebug("SetPreferences.problem_name = " + v);
      ...
      if (d = c.getElementName(a[b]), m.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            for (var e = t.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = t.getElementAttr(e[f], "label"), k = t.getElementAttr(e[f], "pSlip"), l = t.getElementAttr(e[f], "description"), p = t.getElementAttr(e[f], "pKnown"), q = t.getElementAttr(e[f], "category"), u = t.getElementAttr(e[f], "pLearn"), r = t.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(q, h, r, p, k, u);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
          ...
          case "problem_state_status":
            z.transition(CTATMsgType.SET_PREFERENCES, c.getNodeTextValue(a[b]));
            A || (A = new ProblemStateRestorer(m));
            m.ctatdebug("SetPreferences problemStateRestorer " + A);
            break;
          case "curriculum_service_url":
            C.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
          case "restore_problem_url":
            A || (A = new ProblemStateRestorer(m));
            m.ctatdebug("SetPreferences problemStateRestorer " + A);
            A.setRestoreProblemUrl(c.getNodeTextValue(a[b]));
            break;
          case "session_id":
            H = c.getNodeTextValue(a[b]);
            break;
          case "authenticity_token":
            C.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    m.ctatdebug("questionFile " + n + ", outputStatus " + z + ", problemStateRestorer " + A);
    a = n;
    m.ctatdebug("retrieveBRD (" + a + ")");
    L.retrieveXMLFile(a, c, m);
    A && A.retrieveMessages(z);
  }
  function e(a, b, c, d) {
    b = b.getTransactionID();
    m.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    C.appendToProblemState(a, m.getOutputStatus(), !1);
    if (!J) {
      return !1;
    }
  ...
  function h(a, b) {
    ...
    var c = null;
    a.getOutLinks().forEach(function(a) {
      null === c && a.isTutorPerformed(b) && (c = a);
    });
    return c;
  }
  function k(a, b, c, e, g, h) {
    ...
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || C.appendToProblemState(h, m.getOutputStatus(), !1);
    k.setTransactionID(g);
    var n;
    m.ctatdebug("finishNewExampleTrace(" + k + ", " + b + ", " + c + ", " + e + ")");
    h = k.getStudentSAI();
    var l = k.getTutorSAI(), p = k.getTransactionID(), u = new CTATTutorMessageBuilder, r = [];
    null !== k.getReportableLink() && "undefined" !== typeof k.getReportableLink() ? r[0] = k.getReportableLink() : r[0] = null;
    var r = r[0], t = null;
    if (k.isSolverResult()) {
      k.getResult();
    } else {
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        n = r ? "" + r.getUniqueID() : "", k.setStepID(n), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, u.createCorrectActionMessage(p, l), k), null !== r && "undefined" !== typeof r && m.updateSkills(CTATExampleTracerSkill.CORRECT, r.getSkillNames(), r.getUniqueID()), n = k.getSuccessOrBuggyMsg(), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, u.createAssociatedRulesMessageForAction(k.getResult(), l, 
        h, m.getSkillBarVector(), r.getUniqueID(), p, n), k), m.ctatdebug("finishNewExampleTrace() successMsg " + n), n && m.messageTank.addToMessageTank("SuccessMessage", u.createSuccessMessage(p, n), k), w = null, e && (t = f(r ? r.getNextNode() : null, q.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = t);
      } else {
        m.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, u.createInCorrectActionMessage(p, h), k);
        m.ctatdebug("about to do silent traceForHint(" + h + "), selectionArray " + h.getSelectionArray());
        var v = m.lastSilentHintResult = new CTATExampleTracerEvent(m, h, c), t = q.traceForHint(v);
        m.ctatdebug("silent hint result: " + v + "; hintLink " + t);
        t || (t = q.getBestNextLink(!1, v), m.ctatdebug("getBestNextLink result: " + v + "; hintLink " + t));
        l = v ? v.getTutorSAI() : null;
        t && (n = "" + t.getUniqueID(), k.setStepID(n));
        v = d(k, v, u);
        m.ctatdebug("createBuggyMessage() tutorAdvice: " + v.tutorAdvice + ";\n  msg " + v.msg);
        m.updateSkills(CTATExampleTracerSkill.INCORRECT, t.getSkillNames(), t.getUniqueID());
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, u.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : h, h, m.getSkillBarVector(), n, p, v.tutorAdvice), k);
        v.msg && m.messageTank.addToMessageTank(v.msgType, v.msg, k);
        w = h;
        e && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() && (t = f(r ? r.getNextNode() : null, q.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = t);
      }
    }
    m.lastResult = k;
  ...
  function l() {
    z.transition(CTATMsgType.PROBLEM_RESTORE_END);
  ...
  var m = this, n = null, q, r, u, t = new CTATXML;
  new XMLSerializer;
  var w = null, x, B = CTATMsgType.SHOW_ALL_FEEDBACK, D = !0, p = !1, y = null, v = null, C = new ProblemStateSaver(m), A = null, z = new CTATProblemStateStatus, E = [], F = [], G = 0, J = !1, H = "";
  m.ctatdebug("CTATExampleTracer constructor outputStatus=" + z);
  ...
  this.setWorking = function(b, c) {
    c ? G |= 1 << b : (G &= -65537 >> 16 - b, a());
  };
  this.processXML = function(a) {
    m.ctatdebug("processXML ()");
    if (null != a) {
      m.ctatdebug("No of children" + t.getElementChildren(a).length);
      var b = new CTATGraphParser, c = b.parseGraph(a, m);
      u = c.gr;
      q = c.tracer;
      p = b.getSuppressStudentFeedback() === CTATMsgType.HIDE_ALL_FEEDBACK;
      a = c.ssm;
      var d = c.sgMsg;
      m.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + z);
      for (var c = [], e = new XMLSerializer, g = -1, h = 0;h < a.length;h++) {
        if ("message" == t.getElementName(a[h])) {
          var k = e.serializeToString(a[h]), l = CTATMsgType.getMessageType(k);
          CTATMsgType.UNTUTORED_ACTION != l && CTATMsgType.INTERFACE_ACTION != l || m.setVariablesFromSAI(a[h], t);
          z.isIncomplete() && CTATMsgType.START_STATE_END == l ? g = 0 : c.push(k);
        }
      }
      d = c.unshift(d);
      e = new CTATTutorMessageBuilder;
      c.splice(d - g, 0, e.createLockWidgetMsg(b.getLockWidget()));
      m.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + z);
      m.sendBundle(c);
      b = [];
      a = u.getStartNode();
      c = u.getStudentStartsHereNode();
      null != a && null != c && a.getNodeID() != c.getNodeID() && (b = u.getBestSubpath(a, c), m.ctatdebug("advanceToStudentStartsHere() path " + b), b = b.getSortedLinks(), b = m.traceLinks(b), m.ctatdebug("advanceToStudentStartsHere() results " + b));
      c = a = null;
      ...
      f(a, q.findCurrentState(!1, !1), null, c);
      J = !0;
    }
    m.setWorking(0, !1);
  };
  this.sendBundle = function(a) {
    m.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + z);
    for (var b = 0, c = 0;c < a.length;c++) {
      m.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      C.forwardToInterface(d, c >= a.length - 1, z) && ++b;
    }
    return 0 < b;
  };
  ...
  this.getProblemSummary = function(a) {
    ...
    a && y.setRequiredSteps(a.countStepsForScore(u));
    return y;
  };
  ...
  this.getSkillBarVector = function() {
    ...
    return null === a || "undefined" === typeof a ? null : a.getSkillBarVector(!1, !1);
  };
  ...
  this.setOutputStatus = function(a) {
    ...
    CTATProblemStateStatus[a] ? z.setStatus(CTATProblemStateStatus[a]) : (console.error("CTATExampleTracer.setOutputStatus() unexpected argument " + a), z.setStatus(CTATProblemStateStatus.empty));
  };
  this.getFeedbackPolicy = function() {
    return B;
  };
  this.setFeedbackPolicy = function(a) {
    B = "false" === a ? CTATMsgType.SHOW_ALL_FEEDBACK : "true" === a ? CTATMsgType.HIDE_ALL_FEEDBACK : a;
  };
  ...
  this.getOutOfOrderMessage = function() {
    return r ? r : CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE;
  };
